...
const Et = typeof navigator < "u" ? navigator : null, wd = typeof document < "u" ? document : null, Vn = Et && Et.userAgent || "", Ou = /Edge\/(\d+)/.exec(Vn), Hh = /MSIE \d/.exec(Vn), Nu = /Trident\/(?:[7-9]|\d{2,})\..*rv:(\d+)/.exec(Vn), We = !!(Hh || Nu || Ou), kn = Hh ? document.documentMode : Nu ? +Nu[1] : Ou ? +Ou[1] : 0, mt = !We && /gecko\/(\d+)/i.test(Vn);
mt && +(/Firefox\/(\d+)/.exec(Vn) || [0, 0])[1];
const Lu = !We && /Chrome\/(\d+)/.exec(Vn), Re = !!Lu, Rh = Lu ? +Lu[1] : 0, Be = !We && !!Et && /Apple Computer/.test(Et.vendor), Br = Be && (/Mobile\/\w+/.test(Vn) || !!Et && Et.maxTouchPoints > 2), rt = Br || (Et ? /Mac/.test(Et.platform) : !1), j3 = Et ? /Win/.test(Et.platform) : !1, Wt = /Android \d/.test(Vn), to = !!wd && "webkitFontSmoothing" in wd.documentElement.style, W3 = to ? +(/\bAppleWebKit\/(\d+)/.exec(navigator.userAgent) || [0, 0])[1] : 0;
function q3(t) {
...
function Bh(t, e, n) {
  ...
  if (r.nodeType == 3)
    if (s && (t6.test(r.nodeValue) || (n < 0 ? !i : i == r.nodeValue.length))) {
      let u = an($t(r, i, i), n);
...
function i6(t, e, n) {
  ...
  return a ? !r6.test(r.parent.textContent) || !a.modify ? n == "left" || n == "backward" ? o : s : Fh(t, e, () => {
...
function o6(t, e, n) {
  return Cd == e && Ad == n ? Sd : (Cd = e, Ad = n, Sd = n == "up" || n == "down" ? n6(t, e, n) : i6(t, e, n));
}
...
class Cn extends no {
  ...
  static create(e, n, r, i, o, s) {
    ...
    let f = c;
    return c = qh(c, r, n), l ? u = new a6(e, n, r, i, c, d || null, f, l, o, s + 1) : n.isText ? new ua(e, n, r, i, c, f, o) : new Cn(e, n, r, i, c, d || null, f, o, s + 1);
  }
  parseRule() {
  ...
  // `this.children`.
  updateChildren(e, n) {
    let r = this.node.inlineContent, i = n, o = e.composing ? this.localCompositionInfo(e, n) : null, s = o && o.pos > -1 ? o : null, a = o && o.pos < 0, u = new l6(this, s && s.node, e);
    f6(this.node, this.innerDeco, (l, c, d) => {
    ...
    }), u.syncToMarks([], r, e), this.node.isTextblock && u.addTextblockHacks(), u.destroyRest(), (u.changed || this.dirty == jn) && (s && this.protectLocalComposition(e, s), jh(this.contentDOM, this.children, e), Br && p6(this.dom));
  }
  localCompositionInfo(e, n) {
    ...
    if (this.node.inlineContent) {
      let s = o.nodeValue, a = h6(this.node.content, s, r - n, i - n);
...
class l6 {
  constructor(e, n, r) {
    this.lock = n, this.view = r, this.index = 0, this.stack = [], this.changed = !1, this.top = e, this.preMatch = c6(e.node.content, e);
  }
...
function Gt(t, e = !1) {
  ...
  if (Kh(t, n), !!Uh(t)) {
    ...
    if (t.domObserver.disconnectSelection(), t.cursorWrapper)
      ...
      Od && !(n instanceof I) && (n.$from.parent.inlineContent || (o = Nd(t, n.from)), !n.empty && !n.$from.parent.inlineContent && (s = Nd(t, n.to))), t.docView.setSelection(r, i, t, e), Od && (o && Ld(o), s && Ld(s)), n.visible ? t.dom.classList.remove("ProseMirror-hideselection") : (t.dom.classList.add("ProseMirror-hideselection"), "onselectionchange" in document && m6(t));
    }
...
function Du(t, e, n) {
  if (e.nodeType != 3) {
    let o, s;
    (s = w6(e, n)) ? (e = s, n = 0) : (o = x6(e, n)) && (e = o, n = o.nodeValue.length);
  }
...
`))), 0, 0) : L.empty;
  ...
  if (a || (a = (t.someProp("clipboardParser") || t.someProp("domParser") || xn.fromSchema(t.state.schema)).parseSlice(s, {
    ...
    context: i,
    ruleFromNode(f) {
      return f.nodeName == "BR" && !f.nextSibling && f.parentNode && !S6.test(f.parentNode.nodeName) ? { ignore: !0 } : null;
    }
  })), c)
    a = N6(Bd(a, +c[1], +c[2]), c[4]);
  else if (a = L.maxOpen(T6(a.content, i), !0), a.openStart || a.openEnd) {
    let d = 0, f = 0;
...
const S6 = /^(a|abbr|acronym|b|cite|code|del|em|i|ins|kbd|label|output|q|ruby|s|samp|span|strong|sub|sup|time|u|tt|var)$/i;
function T6(t, e) {
  if (t.childCount < 2)
    return t;
  for (let n = e.depth; n >= 0; n--) {
...
function E6(t) {
  ...
  if ((i = r && t0[r[1].toLowerCase()]) && (t = i.map((o) => "<" + o + ">").join("") + t + i.map((o) => "</" + o + ">").reverse().join("")), n.innerHTML = M6(t), i)
    for (let o = 0; o < i.length; o++)
...
const Fe = {}, ze = {}, L6 = { touchstart: !0, touchmove: !0 };
class V6 {
  constructor() {
...
function H6(t) {
  for (let e in Fe) {
    ...
    t.dom.addEventListener(e, t.input.eventHandlers[e] = (r) => {
      D6(t, r) && !Vl(t, r) && (t.editable || !(r.type in ze)) && n(t, r);
    }, L6[e] ? { passive: !0 } : void 0);
  }
...
ze.keydown = (t, e) => {
  ...
  if (t.input.shiftKey = n.keyCode == 16 || n.shiftKey, !i0(t, n) && (t.input.lastKeyCode = n.keyCode, t.input.lastKeyCodeTime = Date.now(), !(Wt && Re && n.keyCode == 13)))
    ...
    } else t.someProp("handleKeyDown", (r) => r(t, n)) || A6(t, n) ? n.preventDefault() : vn(t, "key");
};
ze.keyup = (t, e) => {
...
function F6(t, e, n, r, i) {
  return Hl(t, "handleClickOn", e, n, r) || t.someProp("handleClick", (o) => o(t, e, r)) || (i ? B6(t, n) : I6(t, n));
}
function z6(t, e, n, r) {
  return Hl(t, "handleDoubleClickOn", e, n, r) || t.someProp("handleDoubleClick", (i) => i(t, e, r));
}
function $6(t, e, n, r) {
  return Hl(t, "handleTripleClickOn", e, n, r) || t.someProp("handleTripleClick", (i) => i(t, e, r)) || j6(t, n, r);
}
function j6(t, e, n) {
  if (n.button != 0)
    return !1;
...
Fe.mousedown = (t, e) => {
  ...
  i - t.input.lastClick.time < 500 && P6(n, t.input.lastClick) && !n[r0] && (t.input.lastClick.type == "singleClick" ? o = "doubleClick" : t.input.lastClick.type == "doubleClick" && (o = "tripleClick")), t.input.lastClick = { time: i, x: n.clientX, y: n.clientY, type: o };
  let s = t.posAtCoords(la(n));
  s && (o == "singleClick" ? (t.input.mouseDown && t.input.mouseDown.done(), t.input.mouseDown = new W6(t, s, n, !!r)) : (o == "doubleClick" ? z6 : $6)(t, s.pos, s.inside, n) ? n.preventDefault() : vn(t, "pointer"));
};
class W6 {
  constructor(e, n, r, i) {
  ...
  up(e) {
    if (this.done(), !this.view.dom.contains(e.target))
      return;
    let n = this.pos;
    this.view.state.doc != this.startDoc && (n = this.view.posAtCoords(la(e))), this.updateAllowDefault(e), this.allowDefault || !n ? vn(this.view, "pointer") : F6(this.view, n.pos, n.inside, e, this.selectNode) ? e.preventDefault() : e.button == 0 && (this.flushed || // Safari ignores clicks on draggable elements
...
function s0(t) {
  for (t.composing && (t.input.composing = !1, t.input.compositionEndedAt = K6()); t.input.compositionNodes.length > 0; )
...
const Fi = We && kn < 15 || Br && W3 < 604;
Fe.copy = ze.cut = (t, e) => {
  let n = e, r = t.state.selection, i = n.type == "cut";
  if (r.empty)
    return;
  let o = Fi ? null : n.clipboardData, s = r.content(), { dom: a, text: u } = Zh(t, s);
  o ? (n.preventDefault(), o.clearData(), o.setData("text/html", a.innerHTML), o.setData("text/plain", u)) : G6(t, a), i && t.dispatch(t.state.tr.deleteSelection().scrollIntoView().setMeta("uiEvent", "cut"));
};
function J6(t) {
...
function zi(t, e, n, r, i) {
  ...
  if (!o)
    return !1;
  let s = J6(o), a = s ? t.state.tr.replaceSelectionWith(s, r) : t.state.tr.replaceSelection(o);
...
ze.paste = (t, e) => {
  ...
  r && zi(t, a0(r), r.getData("text/html"), i, n) ? n.preventDefault() : Z6(t, n);
};
class u0 {
  constructor(e, n, r) {
...
class oe {
  ...
  */
  mapInner(e, n, r, i, o) {
    ...
    return this.children.length ? X6(this.children, s || [], e, n, r, i, o) : s ? new oe(s.sort(Zn), Cr) : He;
  }
  /**
...
function X6(t, e, n, r, i, o, s) {
  ...
  if (u) {
    let l = Y6(a, t, e, n, i, o, s), c = fs(l, r, 0, s);
    e = c.local;
...
class nv {
  constructor(e, n) {
    this.view = e, this.handleDOMChange = n, this.queue = [], this.flushingSoon = -1, this.observer = null, this.currentSelection = new tv(), this.onCharData = null, this.suppressingSelectionUpdates = !1, this.lastChangedTextNode = null, this.observer = window.MutationObserver && new window.MutationObserver((r) => {
      for (let i = 0; i < r.length; i++)
        this.queue.push(r[i]);
  ...
  start() {
    this.observer && (this.observer.takeRecords(), this.observer.observe(this.view.dom, Q6)), this.onCharData && this.view.dom.addEventListener("DOMCharacterDataModified", this.onCharData), this.connectSelection();
  }
  stop() {
    if (this.observer) {
  ...
  flush() {
    ...
    if (mt && u.length) {
      ...
      if (c.length == 2) {
        ...
        for (let f of c) {
          let p = f.parentNode;
          p && p.nodeName == "LI" && (!d || ov(e, d) != p) && f.remove();
        }
      }
    }
    let l = null;
    o < 0 && i && e.input.lastFocus > Date.now() - 200 && Math.max(e.input.lastTouch, e.input.lastClick.time) < Date.now() - 300 && aa(r) && (l = Nl(e)) && l.eq(F.near(e.state.doc.resolve(0), 1)) ? (e.input.lastFocus = 0, Gt(e), this.currentSelection.set(r), e.scrollToSelection()) : (o > -1 || i) && (o > -1 && (e.docView.markDirty(o, s), rv(e)), this.handleDOMChange(o, s, a, u), e.docView && e.docView.dirty ? e.updateState(e.state) : this.currentSelection.eq(r) || Gt(e), this.currentSelection.set(r));
  }
...
const uv = /^(a|abbr|acronym|b|bd[io]|big|br|button|cite|code|data(list)?|del|dfn|em|i|ins|kbd|label|map|mark|meter|output|q|ruby|s|samp|small|span|strong|su[bp]|time|u|tt|var)$/i;
function lv(t, e, n, r, i) {
  ...
  let u = t.state.selection, l = sv(t, e, n), c = t.state.doc, d = c.slice(l.from, l.to), f, p;
  ...
  let h = fv(d.content, l.doc.content, l.from, f, p);
  if (h && t.input.domChangeCount++, (Br && t.input.lastIOSEnter > Date.now() - 225 || Wt) && i.some((O) => O.nodeType == 1 && !uv.test(O.nodeName)) && (!h || h.endA >= h.endB) && t.someProp("handleKeyDown", (O) => O(t, zn(13, "Enter")))) {
  ...
  if (t.state.selection.anchor > h.start && dv(c, h.start, h.endA, m, g) && t.someProp("handleKeyDown", (O) => O(t, zn(8, "Backspace")))) {
  ...
  if (x) {
    if (m.pos == g.pos)
      ...
      h.endA == h.endB && (M = cv(m.parent.content.cut(m.parentOffset, g.parentOffset), b.parent.content.cut(b.parentOffset, h.endA - b.start())))
    )
...
class pv {
  ...
  */
  ...
  updateStateInner(e, n) {
    ...
    if (a || this._props.plugins != n.plugins || this._props.nodeViews != n.nodeViews) {
      let p = Zd(this);
      mv(p, this.nodeViews) && (this.nodeViews = p, o = !0);
    }
    ...
    if (s) {
      ...
      let p = d && (We || Re) && !this.composing && !i.selection.empty && !e.selection.empty && hv(i.selection, e.selection);
      if (d) {
        let h = Re ? this.trackWrites = this.domSelectionRange().focusNode : null;
        this.composing && (this.input.compositionNode = U6(this)), (o || !this.docView.update(e.doc, l, u, this)) && (this.docView.updateOuterDeco(l), this.docView.destroy(), this.docView = Md(e.doc, l, u, this.dom, this)), h && !this.trackWrites && (p = !0);
      }
      p || !(this.input.mouseDown && this.domObserver.currentSelection.eq(this.domSelectionRange()) && b6(this)) ? Gt(this, p) : (Kh(this, e.selection), this.domObserver.setCurSelection()), this.domObserver.start();
    }
  ...
  */
  destroy() {
    this.docView && (R6(this), this.destroyPluginViews(), this.mounted ? (this.docView.update(this.state.doc, [], $a(this), this), this.dom.textContent = "") : this.dom.parentNode && this.dom.parentNode.removeChild(this.dom), this.docView.destroy(), this.docView = null, _3());
  }
  /**
  ...
  */
  domSelectionRange() {
    ...
    return e ? Be && this.root.nodeType === 11 && z3(this.dom.ownerDocument) == this.dom && iv(this, e) || e : { focusNode: null, focusOffset: 0, anchorNode: null, anchorOffset: 0 };
  }
  /**
  @internal
  */
...
var Tn = {
  ...
  221: "}",
  222: '"'
}, gv = typeof navigator < "u" && /Mac/.test(navigator.platform), bv = typeof navigator < "u" && /MSIE \d|Trident\/(?:[7-9]|\d{2,})\..*rv:(\d+)/.exec(navigator.userAgent);
...
function yv(t) {
  var e = gv && t.metaKey && t.shiftKey && !t.ctrlKey && !t.altKey || bv && t.shiftKey && t.key && t.key.length == 1 || t.key == "Unidentified", n = !e && t.key || (t.shiftKey ? ps : Tn)[t.keyCode] || t.key || "Unidentified";
  return n == "Esc" && (n = "Escape"), n == "Del" && (n = "Delete"), n == "Left" && (n = "ArrowLeft"), n == "Up" && (n = "ArrowUp"), n == "Right" && (n = "ArrowRight"), n == "Down" && (n = "ArrowDown"), n;
}
const vv = typeof navigator < "u" ? /Mac|iP(hone|[oa]d)/.test(navigator.platform) : !1;
function wv(t) {
...
const Iv = v0(-1), Bv = v0(1);
function Fv(t, e = null) {
  return function(n, r) {
...
function zv(t, e = null) {
  return function(n, r) {
    ...
    if (!s)
      return !1;
    let a = r ? n.tr : null;
    return $v(a, s, t, e) ? (r && r(a.scrollIntoView()), !0) : !1;
  };
}
function $v(t, e, n, r = null) {
...
function Wv(t) {
  return function(e, n) {
    ...
    return o ? n ? r.node(o.depth - 1).type == t ? qv(e, n, t, o) : Uv(e, n, o) : !0 : !1;
  };
}
function qv(t, e, n, r) {
  ...
  return "style" in t ? t : {
    ...
    getAttrs: (n) => {
      ...
      const i = e.reduce((o, s) => {
        const a = s.attribute.parseHTML ? s.attribute.parseHTML(n) : Zv(n.getAttribute(s.name));
        return a == null ? o : {
          ...o,
          [s.name]: a
        };
...
function ef(t) {
  return Object.fromEntries(
    // @ts-ignore
    Object.entries(t).filter(([e, n]) => e === "attrs" && Jv(n) ? !1 : n != null)
  );
}
function k0(t, e) {
  var n;
...
function So(t) {
  return ew(t) !== "Object" ? !1 : t.constructor === Object && Object.getPrototypeOf(t) === Object.prototype;
}
function ha(t, e) {
  const n = { ...t };
  ...
  return n.map((c) => new se({
    ...
    appendTransaction: (d, f, p) => {
      ...
      if (x) {
        ...
        const { from: v } = b, E = v + k.length, M = ow(k);
        return u({
          rule: c,
          state: p,
          from: v,
...
class qn {
   ...
   */
  static resolve(e) {
    const n = qn.sort(qn.flatten(e)), r = aw(n.map((i) => i.name));
...
const uw = /* @__PURE__ */ ne.create({
...
}), lw = () => ({ editor: t, view: e }) => (requestAnimationFrame(() => {
  var n;
  t.isDestroyed || (e.dom.blur(), (n = window == null ? void 0 : window.getSelection()) === null || n === void 0 || n.removeAllRanges());
}), !0), cw = (t = !1) => ({ commands: e }) => e.setContent("", t), dw = () => ({ state: t, tr: e, dispatch: n }) => {
...
}, fw = (t) => (e) => t(e), pw = () => ({ state: t, dispatch: e }) => Rv(t, e), hw = (t, e) => ({ editor: n, tr: r }) => {
  ...
  return !1;
}, bw = (t) => ({ tr: e, dispatch: n }) => {
  const { from: r, to: i } = t;
  return n && e.delete(r, i), !0;
}, yw = () => ({ state: t, dispatch: e }) => p0(t, e), vw = () => ({ commands: t }) => t.keyboardShortcut("Enter"), ww = () => ({ state: t, dispatch: e }) => Hv(t, e);
...
const xw = (t, e = {}) => ({ tr: n, state: r, dispatch: i }) => {
...
const Cw = (t = null, e = {}) => ({ editor: n, view: r, tr: i, dispatch: o }) => {
  e = {
    scrollIntoView: !0,
    ...e
  };
...
}, Aw = (t, e) => (n) => t.every((r, i) => e(r, { ...n, index: i })), Sw = (t, e) => ({ tr: n, commands: r }) => r.insertContentAt({ from: n.selection.from, to: n.selection.to }, t, e), M0 = (t) => {
...
const Mw = (t) => !("type" in t), Ew = (t, e, n) => ({ tr: r, dispatch: i, editor: o }) => {
  var s;
  if (i) {
    n = {
    ...
    n.updateSelection && Tw(r, r.steps.length - 1, -1), n.applyInputRules && r.setMeta("applyInputRules", { from: u, text: p }), n.applyPasteRules && r.setMeta("applyPasteRules", { from: u, text: p });
  }
  return !0;
}, Ow = () => ({ state: t, dispatch: e }) => Ov(t, e), Nw = () => ({ state: t, dispatch: e }) => Nv(t, e), Lw = () => ({ state: t, dispatch: e }) => Cv(t, e), Vw = () => ({ state: t, dispatch: e }) => Mv(t, e), Hw = () => ({ state: t, dispatch: e, tr: n }) => {
  try {
...
}, Dw = () => ({ state: t, dispatch: e }) => Av(t, e), _w = () => ({ state: t, dispatch: e }) => Sv(t, e);
function E0() {
...
const Iw = (t) => ({ editor: e, view: n, tr: r, dispatch: i }) => {
  const o = Pw(t).split(/-(?!$)/), s = o.find((l) => !["Alt", "Ctrl", "Meta", "Shift"].includes(l)), a = new KeyboardEvent("keydown", {
    key: s === "Space" ? " " : s,
...
const Bw = (t, e = {}) => ({ state: n, dispatch: r }) => {
  const i = Te(t, n.schema);
  return ji(n, i, e) ? Lv(n, r) : !1;
}, Fw = () => ({ state: t, dispatch: e }) => Dv(t, e), zw = (t) => ({ state: e, dispatch: n }) => {
  const r = Te(t, e.schema);
  return Wv(r)(e, n);
}, $w = () => ({ state: t, dispatch: e }) => Vv(t, e);
function ba(t, e) {
...
const jw = (t, e) => ({ tr: n, state: r, dispatch: i }) => {
  let o = null, s = null;
...
}, Ww = () => ({ tr: t, dispatch: e }) => (e && t.scrollIntoView(), !0), qw = () => ({ tr: t, dispatch: e }) => {
  if (e) {
    const n = new st(t.doc);
    t.setSelection(n);
  }
  return !0;
}, Uw = () => ({ state: t, dispatch: e }) => Tv(t, e), Kw = () => ({ state: t, dispatch: e }) => Ev(t, e), Gw = () => ({ state: t, dispatch: e }) => _v(t, e), Jw = () => ({ state: t, dispatch: e }) => Bv(t, e), Zw = () => ({ state: t, dispatch: e }) => Iv(t, e);
function Bu(t, e, n = {}, r = {}) {
  return ms(t, e, {
    slice: !1,
    parseOptions: n,
...
const Xw = (t, e = !1, n = {}, r = {}) => ({ editor: i, tr: o, dispatch: s, commands: a }) => {
  var u, l;
  const { doc: c } = o;
...
function V0(t, e) {
  ...
  return n === "node" ? n4(t, e) : n === "mark" ? O0(t, e) : {};
}
function r4(t, e = JSON.stringify) {
  const n = {};
  return t.filter((r) => {
    const i = e(r);
...
const u4 = (t, e = {}) => ({ tr: n, state: r, dispatch: i }) => {
  ...
  return a4(r, n, u);
}, l4 = (t, e) => ({ tr: n }) => (n.setMeta(t, e), !0), c4 = (t, e = {}) => ({ state: n, dispatch: r, chain: i }) => {
...
const h4 = ({ keepMarks: t = !0 } = {}) => ({ tr: e, state: n, dispatch: r, editor: i }) => {
  ...
  if (!a.parent.isBlock)
    return !1;
  const d = u.parentOffset === u.parent.content.size, f = a.depth === 0 ? void 0 : Qw(a.node(-1).contentMatchAt(a.indexAfter(-1)));
  let p = d && f ? [
    {
      type: f,
      attrs: c
  ...
  return h;
}, m4 = (t, e = {}) => ({ tr: n, state: r, dispatch: i, editor: o }) => {
  var s;
...
}, g4 = (t, e, n, r = {}) => ({ editor: i, tr: o, state: s, dispatch: a, chain: u, commands: l, can: c }) => {
...
}, v4 = (t, e = {}) => ({ state: n, commands: r }) => {
  const i = Te(t, n.schema);
  return ji(n, i, e) ? r.lift(i) : r.wrapIn(i, e);
}, w4 = () => ({ state: t, dispatch: e }) => {
  const n = t.plugins;
  for (let r = 0; r < n.length; r += 1) {
    const i = n[r];
    let o;
...
}, k4 = (t, e = {}) => ({ tr: n, state: r, dispatch: i }) => {
  var o;
...
var T4 = /* @__PURE__ */ Object.freeze({
  __proto__: null,
  blur: lw,
  clearContent: cw,
  clearNodes: dw,
  command: fw,
  createParagraphNear: pw,
  cut: hw,
  ...
  scrollIntoView: Ww,
  selectAll: qw,
  selectNodeBackward: Uw,
  selectNodeForward: Kw,
  selectParentNode: Gw,
  selectTextblockEnd: Jw,
  selectTextblockStart: Zw,
  setContent: Xw,
  setMark: u4,
  setMeta: l4,
  setNode: c4,
...
let _4 = class extends Gv {
   ...
   */
  injectCSS() {
    this.options.injectCSS && document && (this.css = D4(R4, this.options.injectNonce));
  }
  /**
...
var qe = "top", ct = "bottom", dt = "right", Ue = "left", Ul = "auto", ro = [qe, ct, dt, Ue], $r = "start", Wi = "end", I4 = "clippingParents", _0 = "viewport", ui = "popper", B4 = "reference", af = /* @__PURE__ */ ro.reduce(function(t, e) {
  return t.concat([e + "-" + $r, e + "-" + Wi]);
}, []), P0 = /* @__PURE__ */ [].concat(ro, [Ul]).reduce(function(t, e) {
  return t.concat([e, e + "-" + $r, e + "-" + Wi]);
}, []), F4 = "beforeRead", z4 = "read", $4 = "afterRead", j4 = "beforeMain", W4 = "main", q4 = "afterMain", U4 = "beforeWrite", K4 = "write", G4 = "afterWrite", J4 = [F4, z4, $4, j4, W4, q4, U4, K4, G4];
function Nt(t) {
...
function io(t) {
  for (var e = Ye(t), n = uf(t); n && Y4(n) && Yt(n).position === "static"; )
    n = uf(n);
  return n && (Nt(n) === "html" || Nt(n) === "body" && Yt(n).position === "static") ? e : n || Q4(t) || e;
}
function Jl(t) {
...
function nx(t) {
  ...
  if (!(!o || !s)) {
    var d = tx(i.padding, n), f = Gl(o), p = u === "y" ? qe : Ue, h = u === "y" ? ct : dt, m = n.rects.reference[c] + n.rects.reference[u] - s[u] - n.rects.popper[c], g = s[u] - n.rects.reference[u], b = io(o), x = b ? u === "y" ? b.clientHeight || 0 : b.clientWidth || 0 : 0, w = m / 2 - g / 2, y = d[p], k = x - f[c] - d[h], v = x / 2 - f[c] / 2 + w, E = Ci(y, v, k), M = u;
...
function qi(t, e) {
  e === void 0 && (e = {});
  var n = e, r = n.placement, i = r === void 0 ? t.placement : r, o = n.strategy, s = o === void 0 ? t.strategy : o, a = n.boundary, u = a === void 0 ? I4 : a, l = n.rootBoundary, c = l === void 0 ? _0 : l, d = n.elementContext, f = d === void 0 ? ui : d, p = n.altBoundary, h = p === void 0 ? !1 : p, m = n.padding, g = m === void 0 ? 0 : m, b = $0(typeof g != "number" ? g : j0(g, ro)), x = f === ui ? B4 : ui, w = t.rects.popper, y = t.elements[h ? x : f], k = bx(sr(y) ? y : y.contextElement || Rn(t.elements.popper), u, c, s), v = Wr(t.elements.reference), E = q0({
    reference: v,
    element: w,
    strategy: "absolute",
    placement: i
...
function Nx(t) {
  ...
  if (v) {
    if (o) {
      var K, we = y === "y" ? qe : Ue, ye = y === "y" ? ct : dt, le = y === "y" ? "height" : "width", pe = v[y], Me = pe + g[we], bt = pe - g[ye], yt = p ? -M[le] / 2 : 0, Dn = x === $r ? E[le] : M[le], vt = x === $r ? -M[le] : -E[le], _n = e.elements.arrow, Ht = p && _n ? Gl(_n) : {
        width: 0,
        height: 0
    ...
    if (a) {
      var ri, lo = y === "x" ? qe : Ue, co = y === "x" ? ct : dt, _t = v[k], on = k === "y" ? "height" : "width", ii = _t + g[lo], Pn = _t - g[co], oi = [qe, Ue].indexOf(b) !== -1, fo = (ri = _ == null ? void 0 : _[k]) != null ? ri : 0, po = oi ? ii : _t - E[on] - M[on] - fo + B.altAxis, ho = oi ? _t + E[on] + M[on] - fo - B.altAxis : Pn, mo = p && oi ? ex(po, _t, ho) : Ci(p ? po : ii, _t, p ? ho : Pn);
      v[k] = mo, U[k] = mo - _t;
    }
    e.modifiersData[r] = U;
  }
...
var Q0 = {
  ...
  triggerTarget: null
}, Q0, c5), d5 = Object.keys(Ze), f5 = function(e) {
...
function t1(t, e) {
  ...
  var n = Object.keys(t);
  n.forEach(function(r) {
    var i = Ux(Ze, Object.keys(Q0)), o = !qx(i, r);
...
var m5 = 1, Oo = [], Ya = [];
function g5(t, e) {
  var n = Cf(t, Object.assign({}, Ze, e1(yf(e)))), r, i, o, s = !1, a = !1, u = !1, l = !1, c, d, f, p = [], h = gf(ao, n.interactiveDebounce), m, g = m5++, b = null, x = Gx(n.plugins), w = {
                      ...
                      V(M, {
                        ...
                        default: N(() => [
                          ...
                          S(xy)(S(d), "characterCount") ? (H(), ae(De, { key: 0 }, [
                            je("span", E5, Le(S(d).storage.characterCount.words()) + " " + Le(S(f)("editor.words")), 1),
                            je("span", O5, Le(S(d).storage.characterCount.characters()) + " " + Le(S(f)("editor.characters")), 1)
                          ], 64)) : Ge("", !0)
                        ]),
                        _: 1
                      })
...
function hk(t, e) {
  const n = t4(e), r = Kt.fromJSON(n, t);
  return pk(r, n);
}
function mk(t) {
...
xa.parseTag = Uk;
xa.parseAttr = Gk;
var Qk = nc.FilterCSS, nt = ue, N1 = xa, e8 = N1.parseTag, t8 = N1.parseAttr, Go = rc;
function Vo(t) {
  return t == null;
}
function n8(t) {
...
}), KC = /(?:^|\s)(\*\*(?!\s+\*\*)((?:[^*]+))\*\*(?!\s+\*\*))$/, GC = /(?:^|\s)(\*\*(?!\s+\*\*)((?:[^*]+))\*\*(?!\s+\*\*))/g, JC = /(?:^|\s)(__(?!\s+__)((?:[^_]+))__(?!\s+__))$/, ZC = /(?:^|\s)(__(?!\s+__)((?:[^_]+))__(?!\s+__))/g, XC = /* @__PURE__ */ Ke.create({
  name: "bold",
  addOptions() {
    return {
      HTMLAttributes: {}
...
}), dA = /(?:^|\s)(==(?!\s+==)((?:[^=]+))==(?!\s+==))$/, fA = /(?:^|\s)(==(?!\s+==)((?:[^=]+))==(?!\s+==))/g, pA = /* @__PURE__ */ Ke.create({
  name: "highlight",
  addOptions() {
    return {
      multicolor: !1,
          ...
          V(v, null, {
            default: N(() => [
              V(m, {
                ...
                default: N(() => [
                  je("span", NA, Le(S(n)("editor.image.dialog.title")), 1),
                  V(f),
                  V(h, {
                    class: "mx-0",
                    icon: "",
...
}), PA = /(?:^|\s)(\*(?!\s+\*)((?:[^*]+))\*(?!\s+\*))$/, IA = /(?:^|\s)(\*(?!\s+\*)((?:[^*]+))\*(?!\s+\*))/g, BA = /(?:^|\s)(_(?!\s+_)((?:[^_]+))_(?!\s+_))$/, FA = /(?:^|\s)(_(?!\s+_)((?:[^_]+))_(?!\s+_))/g, zA = /* @__PURE__ */ Ke.create({
  name: "italic",
  addOptions() {
    return {
      HTMLAttributes: {}
...
function ZA(t = []) {
  ...
  $e.groups = e;
  const n = new $e();
  Ro == null && (Ro = Gf($A)), Do == null && (Do = Gf(jA)), T(n, "'", uc), T(n, "{", Mi), T(n, "}", Ei), T(n, "[", xs), T(n, "]", ks), T(n, "(", Cs), T(n, ")", As), T(n, "<", Ss), T(n, ">", Ts), T(n, "（", Ms), T(n, "）", Es), T(n, "「", Os), T(n, "」", Ns), T(n, "『", Ls), T(n, "』", Vs), T(n, "＜", Hs), T(n, "＞", Rs), T(n, "&", Ds), T(n, "*", _s), T(n, "@", fn), T(n, "`", Is), T(n, "^", Bs), T(n, ":", mn), T(n, ",", lc), T(n, "$", Fs), T(n, ".", xt), T(n, "=", zs), T(n, "!", cc), T(n, "-", tt), T(n, "%", Oi), T(n, "|", $s), T(n, "+", js), T(n, "#", Ws), T(n, "?", Ni), T(n, '"', dc), T(n, "/", kt), T(n, ";", fc), T(n, "~", Li), T(n, "_", qs), T(n, "\\", Ps), T(n, "・", F1);
  const r = he(n, Bt, sc, {
    [Xu]: !0
  });
  he(r, Bt, r);
...
function QA({
  ...
  const e = t.domain.concat([Ds, _s, fn, Ps, Is, Bs, Fs, zs, tt, sc, Oi, $s, js, Ws, kt, Us, Li, qs]), n = [mn, lc, xt, cc, Oi, Ni, dc, fc, Ss, Ts, Mi, Ei, ks, xs, Cs, As, Ms, Es, Os, Ns, Ls, Vs, Hs, Rs], r = [Ds, uc, _s, Ps, Is, Bs, Fs, zs, tt, Mi, Ei, Oi, $s, js, Ws, Ni, kt, Us, Li, qs], i = et(), o = T(i, Li);
  ...
  W(a, t.domain, s), T(a, xt, b), T(a, tt, g), W(u, t.domain, s), T(u, xt, b), T(u, tt, g), W(E, t.domain, k), T(E, kt, k), T(E, Ni, k), W(B, t.domain, k), W(B, e, k), T(B, kt, k);
  const _ = [
    [Mi, Ei],
    // {}
    [xs, ks],
...
function sS(t) {
  return new se({
    ...
    appendTransaction: (e, n, r) => {
      ...
      if (!i || o)
        return;
      const { tr: s } = r, a = Yw(n.doc, [...e]);
      if (o4(a).forEach(({ newRange: l }) => {
        const c = e4(r.doc, l, (p) => p.isTextblock);
        let d, f;
          ...
          V(v, null, {
            default: N(() => [
              V(g, {
                ...
                default: N(() => [
                  je("span", dS, Le(S(n)("editor.link.dialog.title")), 1),
                  V(p),
                  V(m, {
                    class: "mx-0",
                    icon: "",
...
}), gS = /(?:^|\s)(~~(?!\s+~~)((?:[^~]+))~~(?!\s+~~))$/, bS = /(?:^|\s)(~~(?!\s+~~)((?:[^~]+))~~(?!\s+~~))/g, yS = /* @__PURE__ */ Ke.create({
  name: "strike",
  addOptions() {
    return {
      HTMLAttributes: {}
...
const NT = ["onMouseover", "onMousedown"], LT = /* @__PURE__ */ X({
          ...
          V(y, null, {
            default: N(() => [
              V(m, {
                ...
                default: N(() => [
                  je("span", BT, Le(S(n)("editor.video.dialog.title")), 1),
                  V(f),
                  V(h, {
                    class: "mx-0",
                    icon: "",
  ...
  for (const [r, i] of e)
    n[r] = i;
  return n;
}, zT = {}, $T = { style: { background: "rgb(221,221,221)", display: "flex", "justify-content": "center", "align-items": "center" } };
function jT(t, e) {
  return H(), ae("div", $T, e[0] || (e[0] = [
    je("svg", {
      t: "1738756119280",
      class: "icon",
...
}), GT = /* @__PURE__ */ nm(KT, [["__scopeId", "data-v-15ecd644"]]), JT = /* @__PURE__ */ X({
