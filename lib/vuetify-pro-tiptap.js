...
function HA(t) {
  try {
    ...
    for (const o of e)
      o.name !== "htmlView" && o.options && typeof o.options.enable == "boolean" && (t.storage.htmlView.disabledExtensions || (t.storage.htmlView.disabledExtensions = {}), t.storage.htmlView.disabledExtensions[o.name] = o.options.enable, o.options.enable = !1);
    const n = t.view.dom, r = n.parentElement;
    if (r) {
      const o = n.offsetWidth, s = n.offsetHeight, a = n.scrollHeight;
      r.style.setProperty(
        "--tiptap-editor-width",
        `${o}px`
      ), r.style.setProperty(
        ...
        `${a}px`
      ), r.classList.add("tiptap-preserve-dimensions");
    }
    LA(t);
    const i = EA(t);
    if (i) {
      t.storage.htmlView.overlayElement = i, t.storage.htmlView.isHtmlMode = !0;
      const o = t.view.dom;
      o.parentElement && o.parentElement.classList.add("html-view-mode");
    }
  } catch (e) {
