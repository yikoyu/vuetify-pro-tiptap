...
function EA(t) {
  ...
  const s = OA(o);
  return i.value = s, t.storage.htmlView.htmlContent = s, r.appendChild(i), n.style.position = "relative", n.appendChild(r), setTimeout(() => {
    ...
    try {
      ...
      console.error("Error syncing HTML to editor:", a);
    } finally {
      requestAnimationFrame(() => {
...
function LA(t) {
  try {
    ...
    }, 50), console.log("所有编辑器工具已禁用");
  } catch (e) {
    console.error("禁用工具栏按钮失败:", e);
  }
}
function NA(t) {
  try {
    ...
    console.error("启用工具栏按钮失败:", e);
  }
}
function HA(t) {
  try {
    const e = t.extensionManager.extensions;
    for (const r of e)
      r.name !== "htmlView" && r.options && typeof r.options.enable == "boolean" && (t.storage.htmlView.disabledExtensions || (t.storage.htmlView.disabledExtensions = {}), t.storage.htmlView.disabledExtensions[r.name] = r.options.enable, r.options.enable = !1);
    LA(t);
    const n = EA(t);
    if (n) {
      t.storage.htmlView.overlayElement = n, t.storage.htmlView.isHtmlMode = !0;
      const r = t.view.dom;
      r.parentElement && r.parentElement.classList.add("html-view-mode");
    }
  } catch (e) {
...
function VA(t) {
  try {
    ...
    const n = t.view.dom;
    if (n.parentElement && n.parentElement.classList.remove("html-view-mode"), e && e.trim() !== "") {
      const i = P1(e);
  ...
  addOptions() {
    ...
    return {
      ...
      button: ({ editor: e, t: n }) => ({
        ...
        componentProps: {
          action: () => {
            e.storage.htmlView.isHtmlMode ? VA(e) : HA(e);
          },
          ...
          onRender: () => {
            ...
            return document.addEventListener(
              ...
              onMount: (i) => {
                ...
                o && (o.setAttribute("data-htmlview-btn", "true"), console.log("HTML视图按钮已标记"));
              },
              onDestroy: () => {
