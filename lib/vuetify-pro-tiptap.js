...
var cm = (t, e, n) => e in t ? lm(t, e, { enumerable: !0, configurable: !0, writable: !0, value: n }) : t[e] = n;
var bc = (t, e, n) => cm(t, typeof e != "symbol" ? e + "" : e, n);
import { VDivider as Xi, VToolbar as Kr, VCardText as Yi, VCard as Gr, VSpacer as Qi, VCardTitle as dm, VInput as fm, VThemeProvider as gp, VIcon as On, VTooltip as bp, VBtn as Jr, VTextField as dl, VSheet as pm, VList as fl, VMenu as Ks, VListItemTitle as yp, VListItem as vp, VFileInput as hm, VCheckbox as Gs, VForm as Js, VTab as mm, VTabs as gm, VWindowItem as bm, VWindow as ym, VCardActions as pl, VDialog as hl, VCardSubtitle as vm } from "vuetify/components";
import { reactive as Dr, computed as j, unref as S, watch as Jt, getCurrentScope as wm, onScopeDispose as xm, getCurrentInstance as Zs, inject as km, provide as du, ref as J, onMounted as ml, watchEffect as ur, defineComponent as X, onBeforeUnmount as gl, h as Zr, markRaw as wp, nextTick as Cm, customRef as Am, render as yc, withDirectives as xp, openBlock as H, createBlock as $, withCtx as N, createVNode as V, createElementBlock as ae, Fragment as De, renderList as lt, resolveDynamicComponent as Vi, mergeProps as Er, createSlots as bl, vShow as kp, createCommentVNode as it, useAttrs as Sm, onUnmounted as Tm, normalizeClass as St, createTextVNode as Zt, toDisplayString as Le, renderSlot as Mt, normalizeProps as vc, guardReactiveProps as wc, normalizeStyle as Or, createElementVNode as Ze, resolveComponent as Cp, withModifiers as Ap } from "vue";
import { useTheme as yl } from "vuetify";
const Sp = "en", fu = 200, Mm = fu - 80, xc = 20, kc = 1e5, Cc = 16, yo = 6, vo = 10, wo = 2, Em = [
  "#f44336",
  "#e91e63",
  "#9c27b0",
  "#673ab7",
...
var Tp = typeof global == "object" && global && global.Object === Object && global, Hm = typeof self == "object" && self && self.Object === Object && self, Lt = Tp || Hm || Function("return this")(), Sn = Lt.Symbol, Mp = Object.prototype, Rm = Mp.hasOwnProperty, Dm = Mp.toString, si = Sn ? Sn.toStringTag : void 0;
function _m(t) {
  var e = Rm.call(t, si), n = t[si];
  try {
    t[si] = void 0;
    var r = !0;
  } catch {
...
var Pm = Object.prototype, Im = Pm.toString;
function Bm(t) {
  return Im.call(t);
}
var Fm = "[object Null]", zm = "[object Undefined]", Sc = Sn ? Sn.toStringTag : void 0;
function Xr(t) {
  return t == null ? t === void 0 ? zm : Fm : Sc && Sc in Object(t) ? _m(t) : Bm(t);
}
function Qn(t) {
...
var $m = "[object Symbol]";
function Ys(t) {
  return typeof t == "symbol" || Qn(t) && Xr(t) == $m;
}
function Ep(t, e) {
...
var qm = /^\s+/;
function Um(t) {
  return t && t.slice(0, Wm(t) + 1).replace(qm, "");
}
function er(t) {
  var e = typeof t;
  return t != null && (e == "object" || e == "function");
}
var Ec = NaN, Km = /^[-+]0x[0-9a-f]+$/i, Gm = /^0b[01]+$/i, Jm = /^0o[0-7]+$/i, Zm = parseInt;
function Oc(t) {
  if (typeof t == "number")
    return t;
  if (Ys(t))
  ...
  t = Um(t);
  var n = Gm.test(t);
  return n || Jm.test(t) ? Zm(t.slice(2), n ? 2 : 8) : Km.test(t) ? Ec : +t;
}
function vl(t) {
  return t;
}
var Xm = "[object AsyncFunction]", Ym = "[object Function]", Qm = "[object GeneratorFunction]", eg = "[object Proxy]";
function Np(t) {
  if (!er(t))
    return !1;
  var e = Xr(t);
  return e == Ym || e == Qm || e == Xm || e == eg;
}
var Ta = Lt["__core-js_shared__"], Nc = function() {
...
var ig = /[\\^$.*+?()[\]{}|]/g, og = /^\[object .+?Constructor\]$/, sg = Function.prototype, ag = Object.prototype, ug = sg.toString, lg = ag.hasOwnProperty, cg = RegExp(
  "^" + ug.call(lg).replace(ig, "\\$&").replace(/hasOwnProperty|(function).*?(?=\\\()| for .+?(?=\\\])/g, "$1.*?") + "$"
);
function dg(t) {
  if (!er(t) || tg(t))
    return !1;
...
function Ag(t, e, n) {
  return e === e ? Cg(t, e, n) : xg(t, kg, n);
}
function Sg(t, e) {
  var n = t == null ? 0 : t.length;
  return !!n && Ag(t, e, 0) > -1;
}
var Tg = 9007199254740991, Mg = /^(?:0|[1-9]\d*)$/;
function Lp(t, e) {
  var n = typeof t;
  return e = e ?? Tg, !!e && (n == "number" || n != "symbol" && Mg.test(t)) && t > -1 && t % 1 == 0 && t < e;
}
function Vp(t, e) {
  return t === e || t !== t && e !== e;
}
...
function Eg(t, e, n) {
  return e = Vc(e === void 0 ? t.length - 1 : e, 0), function() {
    ...
    for (var a = Array(e + 1); ++i < e; )
      a[i] = r[i];
    return a[e] = n(s), pg(t, this, a);
  };
}
function Og(t, e) {
  return wg(Eg(t, e, vl), t + "");
}
...
function Hp(t) {
  return t != null && wl(t.length) && !Np(t);
}
var Lg = Object.prototype;
function Vg(t) {
  var e = t && t.constructor, n = typeof e == "function" && e.prototype || Lg;
  return t === n;
}
function Hg(t, e) {
...
var Rp = Object.prototype, Dg = Rp.hasOwnProperty, _g = Rp.propertyIsEnumerable, Dp = Hc(/* @__PURE__ */ function() {
  return arguments;
}()) ? Hc : function(t) {
  return Qn(t) && Dg.call(t, "callee") && !_g.call(t, "callee");
};
function Pg() {
  return !1;
}
var _p = typeof exports == "object" && exports && !exports.nodeType && exports, Rc = _p && typeof module == "object" && module && !module.nodeType && module, Ig = Rc && Rc.exports === _p, Dc = Ig ? Lt.Buffer : void 0, Bg = Dc ? Dc.isBuffer : void 0, mu = Bg || Pg, Fg = "[object Arguments]", zg = "[object Array]", $g = "[object Boolean]", jg = "[object Date]", Wg = "[object Error]", qg = "[object Function]", Ug = "[object Map]", Kg = "[object Number]", Gg = "[object Object]", Jg = "[object RegExp]", Zg = "[object Set]", Xg = "[object String]", Yg = "[object WeakMap]", Qg = "[object ArrayBuffer]", eb = "[object DataView]", tb = "[object Float32Array]", nb = "[object Float64Array]", rb = "[object Int8Array]", ib = "[object Int16Array]", ob = "[object Int32Array]", sb = "[object Uint8Array]", ab = "[object Uint8ClampedArray]", ub = "[object Uint16Array]", lb = "[object Uint32Array]", re = {};
re[tb] = re[nb] = re[rb] = re[ib] = re[ob] = re[sb] = re[ab] = re[ub] = re[lb] = !0;
re[Fg] = re[zg] = re[Qg] = re[$g] = re[eb] = re[jg] = re[Wg] = re[qg] = re[Ug] = re[Kg] = re[Gg] = re[Jg] = re[Zg] = re[Xg] = re[Yg] = !1;
function cb(t) {
...
var Ip = typeof exports == "object" && exports && !exports.nodeType && exports, gi = Ip && typeof module == "object" && module && !module.nodeType && module, db = gi && gi.exports === Ip, Ma = db && Tp.process, _c = function() {
  try {
    var t = gi && gi.require && gi.require("util").types;
    return t || Ma && Ma.binding && Ma.binding("util");
  } catch {
  }
}(), Pc = _c && _c.isTypedArray, Bp = Pc ? Pp(Pc) : cb, fb = Object.prototype, pb = fb.hasOwnProperty;
function hb(t, e) {
  var n = Xt(t), r = !n && Dp(t), i = !n && !r && mu(t), o = !n && !r && !i && Bp(t), s = n || r || i || o, a = s ? Hg(t.length, String) : [], u = a.length;
  for (var l in t)
    pb.call(t, l) && !(s && // Safari 9 has enumerable `arguments.length` in strict mode.
...
var gb = mb(Object.keys, Object), bb = Object.prototype, yb = bb.hasOwnProperty;
function vb(t) {
  if (!Vg(t))
    return gb(t);
  var e = [];
  for (var n in Object(t))
    yb.call(t, n) && n != "constructor" && e.push(n);
  return e;
}
function Fp(t) {
  return Hp(t) ? hb(t) : vb(t);
}
var wb = /\.|\[(?:[^[\]]*|(["'])(?:(?!\1)[^\\]|\\.)*?\1)\]/, xb = /^\w*$/;
function xl(t, e) {
  if (Xt(t))
    return !1;
  var n = typeof t;
  return n == "number" || n == "symbol" || n == "boolean" || t == null || Ys(t) ? !0 : xb.test(t) || !wb.test(t) || e != null && t in Object(e);
}
...
var Ab = "__lodash_hash_undefined__", Sb = Object.prototype, Tb = Sb.hasOwnProperty;
function Mb(t) {
  var e = this.__data__;
  if (Hi) {
    var n = e[t];
  ...
  return Tb.call(e, t) ? e[t] : void 0;
}
var Eb = Object.prototype, Ob = Eb.hasOwnProperty;
function Nb(t) {
  var e = this.__data__;
  return Hi ? e[t] !== void 0 : Ob.call(e, t);
}
var Lb = "__lodash_hash_undefined__";
function Vb(t, e) {
  var n = this.__data__;
  return this.size += this.has(t) ? 0 : 1, n[t] = Hi && e === void 0 ? Lb : e, this;
}
function tr(t) {
...
tr.prototype.clear = kb;
tr.prototype.delete = Cb;
tr.prototype.get = Mb;
tr.prototype.has = Nb;
tr.prototype.set = Vb;
function Hb() {
...
var Rb = Array.prototype, Db = Rb.splice;
function _b(t) {
  var e = this.__data__, n = Qs(e, t);
  if (n < 0)
    return !1;
  var r = e.length - 1;
  return n == r ? e.pop() : Db.call(e, n, 1), --this.size, !0;
}
function Pb(t) {
  var e = this.__data__, n = Qs(e, t);
...
Qt.prototype.clear = Hb;
Qt.prototype.delete = _b;
Qt.prototype.get = Pb;
Qt.prototype.has = Ib;
Qt.prototype.set = Bb;
var Ri = cr(Lt, "Map");
...
var Jb = /[^.[\]]+|\[(?:(-?\d+(?:\.\d+)?)|(["'])((?:(?!\2)[^\\]|\\.)*?)\2)\]|(?=(?:\.|\[\])(?:\.|\[\]|$))/g, Zb = /\\(\\)?/g, Xb = Gb(function(t) {
  var e = [];
  return t.charCodeAt(0) === 46 && e.push(""), t.replace(Jb, function(n, r, i, o) {
    e.push(i ? o.replace(Zb, "$1") : r || n);
  }), e;
});
function Yb(t) {
  return t == null ? "" : Op(t);
...
function zp(t, e) {
  return Xt(t) ? t : xl(t, e) ? [t] : Xb(Yb(t));
}
function ta(t) {
...
Ut.prototype.clear = t2;
Ut.prototype.delete = n2;
Ut.prototype.get = r2;
Ut.prototype.has = i2;
Ut.prototype.set = s2;
function a2(t, e) {
...
var l2 = Object.prototype, c2 = l2.propertyIsEnumerable, Ic = Object.getOwnPropertySymbols, d2 = Ic ? function(t) {
  return t == null ? [] : (t = Object(t), a2(Ic(t), function(e) {
    return c2.call(t, e);
  }));
} : u2;
function f2(t, e, n) {
...
var gu = cr(Lt, "DataView"), bu = cr(Lt, "Promise"), yu = cr(Lt, "Set"), Fc = "[object Map]", p2 = "[object Object]", zc = "[object Promise]", $c = "[object Set]", jc = "[object WeakMap]", Wc = "[object DataView]", h2 = lr(gu), m2 = lr(Ri), g2 = lr(bu), b2 = lr(yu), y2 = lr(hu), un = Xr;
(gu && un(new gu(new ArrayBuffer(1))) != Wc || Ri && un(new Ri()) != Fc || bu && un(bu.resolve()) != zc || yu && un(new yu()) != $c || hu && un(new hu()) != jc) && (un = function(t) {
  var e = Xr(t), n = e == p2 ? t.constructor : void 0, r = n ? lr(n) : "";
  if (r)
    switch (r) {
      case h2:
        return Wc;
...
var qc = Lt.Uint8Array, v2 = "__lodash_hash_undefined__";
function w2(t) {
  return this.__data__.set(t, v2), this;
}
function x2(t) {
  return this.__data__.has(t);
}
...
Di.prototype.add = Di.prototype.push = w2;
Di.prototype.has = x2;
function k2(t, e) {
...
function qp(t, e, n, r, i, o) {
  var s = n & C2, a = t.length, u = e.length;
  if (a != u && !(s && u > a))
    return !1;
  var l = o.get(t), c = o.get(e);
  if (l && c)
    return l == e && c == t;
  var d = -1, f = !0, p = n & A2 ? new Di() : void 0;
...
var M2 = 1, E2 = 2, O2 = "[object Boolean]", N2 = "[object Date]", L2 = "[object Error]", V2 = "[object Map]", H2 = "[object Number]", R2 = "[object RegExp]", D2 = "[object Set]", _2 = "[object String]", P2 = "[object Symbol]", I2 = "[object ArrayBuffer]", B2 = "[object DataView]", Uc = Sn ? Sn.prototype : void 0, Ea = Uc ? Uc.valueOf : void 0;
function F2(t, e, n, r, i, o, s) {
  switch (n) {
    case B2:
...
var z2 = 1, $2 = Object.prototype, j2 = $2.hasOwnProperty;
function W2(t, e, n, r, i, o) {
  var s = n & z2, a = Bc(t), u = a.length, l = Bc(e), c = l.length;
  if (u != c && !s)
    return !1;
  for (var d = u; d--; ) {
    var f = a[d];
    if (!(s ? f in e : j2.call(e, f)))
      return !1;
  }
...
var q2 = 1, Kc = "[object Arguments]", Gc = "[object Array]", xo = "[object Object]", U2 = Object.prototype, Jc = U2.hasOwnProperty;
function K2(t, e, n, r, i, o) {
  ...
  if (f && !c)
    return o || (o = new Ut()), s || Bp(t) ? qp(t, e, n, r, i, o) : F2(t, e, u, n, r, i, o);
  if (!(n & q2)) {
  ...
  return f ? (o || (o = new Ut()), W2(t, e, n, r, i, o)) : !1;
}
function na(t, e, n, r, i) {
  return t === e ? !0 : t == null || e == null || !Qn(t) && !Qn(e) ? t !== t && e !== e : K2(t, e, n, r, na, i);
}
var G2 = 1, J2 = 2;
function Z2(t, e, n, r) {
  var i = n.length, o = i;
  ...
  for (; ++i < o; ) {
    ...
    if (s[2]) {
      ...
      var c = new Ut(), d;
      if (!(d === void 0 ? na(l, u, G2 | J2, r, c) : d))
        return !1;
    }
  }
  return !0;
...
function ey(t, e, n) {
  ...
  return o || ++r != i ? o : (i = t == null ? 0 : t.length, !!i && wl(i) && Lp(s, i) && (Xt(t) || Dp(t)));
}
function ty(t, e) {
  return t != null && ey(t, e, Q2);
}
var ny = 1, ry = 2;
function iy(t, e) {
  return xl(t) && Up(e) ? Kp(ta(t), e) : function(n) {
    var r = Qb(n, t);
    return r === void 0 && r === e ? ty(n, t) : na(e, r, ny | ry);
  };
}
function oy(t) {
  return function(e) {
...
function ay(t) {
  return xl(t) ? oy(ta(t)) : sy(t);
}
function uy(t) {
  return typeof t == "function" ? t : t == null ? vl : typeof t == "object" ? Xt(t) ? iy(t[0], t[1]) : Y2(t) : ay(t);
}
var Oa = function() {
  return Lt.Date.now();
}, ly = "Expected a function", cy = Math.max, dy = Math.min;
function fy(t, e, n) {
  var r, i, o, s, a, u, l = 0, c = !1, d = !1, f = !0;
  if (typeof t != "function")
    throw new TypeError(ly);
  e = Oc(e) || 0, er(n) && (c = !!n.leading, d = "maxWait" in n, o = d ? cy(Oc(n.maxWait) || 0, e) : o, f = "trailing" in n ? !!n.trailing : f);
  function p(v) {
    var E = r, M = i;
...
var py = 200;
function hy(t, e, n, r) {
  var i = -1, o = Sg, s = !0, a = t.length, u = [], l = e.length;
  if (!a)
    return u;
  n && (e = Ep(e, Pp(n))), e.length >= py && (o = Wp, s = !1, e = new Di(e));
  e:
    for (; ++i < a; ) {
...
var gy = Og(function(t, e) {
  var n = my(e);
  return Na(n) && (n = void 0), Na(t) ? hy(t, e2(e, 1, Na), uy(n)) : [];
});
function by(t, e) {
  return na(t, e);
}
...
function bi(t, e, n) {
  ...
  return er(n) && (r = "leading" in n ? !!n.leading : r, i = "trailing" in n ? !!n.trailing : i), fy(t, e, {
    leading: r,
    maxWait: e,
    trailing: i
  });
...
const vu = (t) => typeof t == "number", yi = (t) => typeof t == "string", _r = (t) => typeof t == "boolean", wy = (t) => typeof t == "function", vi = (t, e = "px") => {
  if (!t) return t;
...
const Nr = /* @__PURE__ */ new WeakMap(), ky = (...t) => {
  var e;
  const n = t[0], r = (e = Zs()) == null ? void 0 : e.proxy;
  if (r == null)
    throw new Error("injectLocal must be called in setup");
  return Nr.has(r) && n in Nr.get(r) ? Nr.get(r)[n] : km(...t);
}, Cy = (t, e) => {
  var n;
...
const Sy = Object.prototype.toString, Ty = (t) => Sy.call(t) === "[object Object]", My = () => {
}, Ey = Xp ? window : void 0, Oy = Xp ? window.document : void 0;
function wu(t) {
  var e;
  const n = Zp(t);
...
function Zc(...t) {
  let e, n, r, i;
  if (typeof t[0] == "string" || Array.isArray(t[0]) ? ([n, r, i] = t, e = Ey) : [e, n, r, i] = t, !e)
    return My;
...
function Vy(t, e = {}) {
  const {
    ...
    "msFullscreenElement"
  ].find((b) => n && b in n), c = Ly(() => i.value && n && s.value !== void 0 && a.value !== void 0 && u.value !== void 0), d = () => l ? (n == null ? void 0 : n[l]) === i.value : !1, f = () => {
    if (u.value) {
      if (n && n[u.value] != null)
        return n[u.value];
      {
...
class L {
  ...
  */
  removeBetween(e, n) {
    return new L(th(this.content, e + this.openStart, n + this.openStart), this.openStart, this.openEnd);
  }
  /**
...
const qy = 12, Qc = /* @__PURE__ */ new WeakMap();
class ss {
  /**
...
let Kt = class Au {
  ...
  */
  hasMarkup(e, n, r) {
    return this.type == e && ns(this.attrs, n || e.defaultAttrs || Uy) && ee.sameSet(this.marks, r || ee.none);
  }
  /**
  ...
  */
  slice(e, n = this.content.size, r = !1) {
    ...
    return new L(l, i.depth - s, o.depth - s);
  }
  /**
  ...
  */
  replace(e, n, r) {
    return $y(this.resolve(e), this.resolve(n), r);
  }
  /**
...
function Yy(t) {
  if (t.eat("(")) {
    ...
    let e = Xy(t, t.next).map((n) => (t.inline == null ? t.inline = n.isInline : t.inline != n.isInline && t.err("Mixing inline and block content"), { type: "name", value: n }));
...
class r3 {
  constructor(e, n, r) {
    this.hasDefault = Object.prototype.hasOwnProperty.call(r, "default"), this.default = r.default, this.validate = typeof r.validate == "string" ? n3(e, n, r.validate) : r.validate;
  }
  get isRequired() {
...
class xn {
  ...
  */
  parseSlice(e, n = {}) {
    ...
    return r.addAll(e, ee.none, n.from, n.to), L.maxOpen(r.finish());
  }
  /**
  @internal
  */
  matchTag(e, n, r) {
    for (let i = r ? this.tags.indexOf(r) + 1 : 0; i < this.tags.length; i++) {
      let o = this.tags[i];
      if (u3(e, o.tag) && (o.namespace === void 0 || e.namespaceURI == o.namespace) && (!o.context || n.matchesContext(o.context))) {
        if (o.getAttrs) {
          let s = o.getAttrs(e);
          if (s === !1)
            continue;
...
class Nn {
  ...
  */
  serializeNodeInner(e, n) {
    let { dom: r, contentDOM: i } = jo(Va(n), this.nodes[e.type.name](e), null, e.attrs);
    if (i) {
      if (e.isLeaf)
  ...
  */
  serializeMark(e, n, r = {}) {
    ...
    return i && jo(Va(r), i(e, n), null, e.attrs);
  }
...
function l3(t) {
  let e = ld.get(t);
  return e === void 0 && ld.set(t, e = c3(t)), e;
}
function c3(t) {
  let e = null;
  function n(r) {
  ...
  _map(e, n, r) {
    ...
    for (let a = 0; a < this.ranges.length; a += 3) {
      ...
      if (e <= d) {
        ...
        if (r)
          return p;
        let h = e == (n < 0 ? u : d) ? null : d3(a / 3, e - u), m = e == u ? wh : e == d ? vh : Wo;
...
class Lr {
  ...
  */
  slice(e = 0, n = this.maps.length) {
    return new Lr(this.maps, this.mirror, e, n);
  }
  /**
  @internal
  */
...
class Pe {
  ...
  */
  static jsonID(e, n) {
    ...
    return Ha[e] = n, n.prototype.jsonID = e, n;
  }
}
class ve {
  /**
...
class bn extends Pe {
  ...
  */
  ...
  apply(e) {
    let n = e.slice(this.from, this.to), r = e.resolve(this.from), i = r.node(r.sharedDepth(this.to)), o = new L(Al(n.content, (s, a) => !s.isAtom || !a.type.allowsMarkType(this.mark.type) ? s : s.mark(this.mark.addToSet(s.marks)), i), n.openStart, n.openEnd);
...
class At extends Pe {
  ...
  */
  ...
  apply(e) {
    let n = e.slice(this.from, this.to), r = new L(Al(n.content, (i) => i.mark(this.mark.removeFromSet(i.marks)), e), n.openStart, n.openEnd);
...
class yn extends Pe {
  ...
  */
  ...
  apply(e) {
    ...
    return ve.fromReplace(e, this.pos, this.pos + 1, new L(A.from(r), 0, n.isLeaf ? 0 : 1));
  }
  invert(e) {
    let n = e.nodeAt(this.pos);
    if (n) {
...
class ke extends Pe {
  ...
  */
  static fromJSON(e, n) {
    ...
    return new ke(n.from, n.to, L.fromJSON(e, n.slice), !!n.structure);
  }
}
...
class Ae extends Pe {
  ...
  */
  static fromJSON(e, n) {
    ...
    return new Ae(n.from, n.to, n.gapFrom, n.gapTo, L.fromJSON(e, n.slice), n.insert, !!n.structure);
  }
}
  ...
  for (let u = 0; u < o.childCount; u++) {
    ...
    if (!d)
      ...
      if (i && l.isText && n.whitespace != "pre") {
        let f, p = /\r?\n|\r/g, h;
        for (; f = p.exec(l.text); )
          h || (h = new L(A.from(n.schema.text(" ", n.allowedMarks(l.marks))), 0, 0)), s.push(new ke(a + f.index, a + f.index + f[0].length, h));
      }
    }
    a = c;
  }
...
function Yr(t) {
  ...
  for (let r = t.depth; ; --r) {
    ...
    if (r < t.depth && i.canReplace(o, s, n))
      return r;
    if (r == 0 || i.type.spec.isolating || !m3(i, o, s))
      break;
  }
  return null;
}
function g3(t, e, n) {
  ...
  t.step(new Ae(u, l, s, a, new L(c.append(f), d, p), c.size - d, !0));
}
function Tl(t, e, n = null, r = t) {
  let i = b3(t, e), o = i && y3(r, e);
...
function v3(t, e, n) {
  ...
  t.step(new Ae(i, o, i, o, new L(r, 0, 0), n.length, !0));
}
function w3(t, e, n, r, i) {
  ...
  t.doc.nodesBetween(e, n, (s, a) => {
    ...
    if (s.isTextblock && !s.hasMarkup(r, u) && x3(t.doc, t.mapping.slice(o).map(a), r)) {
      let l = null;
      ...
      return t.step(new Ae(d, f, d + 1, f - 1, new L(A.from(r.create(u, null, s.marks)), 0, 0), 1, !0)), l === !0 && kh(t, s, a, o), !1;
    }
  });
}
function kh(t, e, n, r) {
...
function k3(t, e, n, r, i) {
  ...
  t.step(new Ae(e, e + o.nodeSize, e + 1, e + o.nodeSize - 1, new L(A.from(s), 0, 0), 1, !0));
}
...
function C3(t, e, n = 1, r) {
  ...
  t.step(new ke(e, e, new L(o.append(s), n, n), !0));
}
function Ln(t, e) {
...
function S3(t, e, n) {
  ...
  if (t.step(new ke(l, u.map(e + n, -1), L.empty, !0)), r === !0) {
...
function oa(t, e, n = e, r = L.empty) {
  if (e == n && !r.size)
    return null;
  let i = t.resolve(e), o = t.resolve(n);
  return Th(i, o, r) ? new ke(e, n, r) : new M3(i, o, r).fit();
}
function Th(t, e, n) {
...
class M3 {
  ...
  dropNode() {
    ...
    if (i.childCount <= 1 && n > 0) {
      ...
      this.unplaced = new L(fi(e, n - 1, 1), n - 1, o ? n - 1 : r);
    } else
      this.unplaced = new L(fi(e, n, 1), n, r);
  }
  ...
  placeNodes({ sliceDepth: e, frontierDepth: n, parent: r, inject: i, wrap: o }) {
    ...
    this.unplaced = h ? e == 0 ? L.empty : new L(fi(s.content, e - 1, 1), e - 1, p < 0 ? s.openEnd : e - 1) : new L(fi(s.content, e, l), s.openStart, s.openEnd);
  }
  mustMoveInline() {
...
function Da(t, e, n, r, i) {
  ...
  return a && !E3(n, o.content, s) ? a : null;
}
function E3(t, e, n) {
    ...
    if (h)
      for (let m = 0; m < s.length; m++) {
        ...
        if (x.canReplaceWith(w, w, h.type, h.marks))
          return t.replace(i.before(g), b ? o.after(g) : n, new L(Eh(r.content, 0, r.openStart, p), p, r.openEnd));
      }
  }
...
class Hr extends Pe {
  ...
  */
  ...
  apply(e) {
    ...
    return ve.fromReplace(e, this.pos, this.pos + 1, new L(A.from(i), 0, n.isLeaf ? 0 : 1));
  }
  getMap() {
    return Ke.empty;
  }
...
class F {
  ...
  */
  constructor(e, n, r) {
    this.$anchor = e, this.$head = n, this.ranges = r || [new Nh(e.min(n), e.max(n))];
  }
  /**
  ...
  */
  replace(e, n = L.empty) {
    ...
    for (let a = 0; a < s.length; a++) {
      ...
      e.replaceRange(c.map(u.pos), c.map(l.pos), a ? L.empty : n), a == 0 && hd(e, o, (r ? r.isInline : i && i.isTextblock) ? -1 : 1);
    }
  }
  /**
...
class Pa {
  constructor(e, n) {
    this.schema = e, this.plugins = [], this.pluginsByKey = /* @__PURE__ */ Object.create(null), this.fields = D3.slice(), n && n.forEach((r) => {
...
function Lh(t, e, n) {
  for (let r in t) {
    let i = t[r];
    i instanceof Function ? i = i.bind(e) : r == "handleDOMEvents" && (i = Lh(i, e, {})), n[r] = i;
  }
  return n;
}
class se {
  ...
  */
  constructor(e) {
    this.spec = e, this.props = {}, e.props && Lh(e.props, this, this.props), this.key = e.key ? e.key.key : Vh("plugin");
  }
  /**
...
function vd(t, e, n, r, i) {
  for (; ; ) {
    ...
    if (e == (i < 0 ? 0 : ot(t))) {
      let o = t.parentNode;
      if (!o || o.nodeType != 1 || eo(t) || P3.test(t.nodeName) || t.contentEditable == "false")
        return !1;
      e = Oe(t) + (i < 0 ? 0 : 1), t = o;
...
const Et = typeof navigator < "u" ? navigator : null, wd = typeof document < "u" ? document : null, Vn = Et && Et.userAgent || "", Ou = /Edge\/(\d+)/.exec(Vn), Hh = /MSIE \d/.exec(Vn), Nu = /Trident\/(?:[7-9]|\d{2,})\..*rv:(\d+)/.exec(Vn), je = !!(Hh || Nu || Ou), kn = Hh ? document.documentMode : Nu ? +Nu[1] : Ou ? +Ou[1] : 0, mt = !je && /gecko\/(\d+)/i.test(Vn);
mt && +(/Firefox\/(\d+)/.exec(Vn) || [0, 0])[1];
const Lu = !je && /Chrome\/(\d+)/.exec(Vn), Re = !!Lu, Rh = Lu ? +Lu[1] : 0, Be = !je && !!Et && /Apple Computer/.test(Et.vendor), Br = Be && (/Mobile\/\w+/.test(Vn) || !!Et && Et.maxTouchPoints > 2), nt = Br || (Et ? /Mac/.test(Et.platform) : !1), j3 = Et ? /Win/.test(Et.platform) : !1, Wt = /Android \d/.test(Vn), to = !!wd && "webkitFontSmoothing" in wd.documentElement.style, W3 = to ? +(/\bAppleWebKit\/(\d+)/.exec(navigator.userAgent) || [0, 0])[1] : 0;
function q3(t) {
...
function xd(t, e, n) {
  ...
  for (let s = n || t.dom; s; s = Bi(s)) {
    if (s.nodeType != 1)
      continue;
    let a = s, u = a == o.body, l = u ? q3(o) : U3(a), c = 0, d = 0;
...
function G3({ refDOM: t, refTop: e, stack: n }) {
...
function Ph(t, e) {
  ...
  return !n && u && (n = u, i = l, r = 0), n && n.nodeType == 3 ? Z3(n, i) : !n || r && n.nodeType == 1 ? { node: t, offset: o } : Ph(n, i);
}
function Z3(t, e) {
...
function ev(t, e) {
  let n = t.dom.ownerDocument, r, i = 0, o = $3(n, e.left, e.top);
  o && ({ node: r, offset: i } = o);
  ...
  if (s = X3(s, e), r) {
    ...
    let l;
    to && i && r.nodeType == 1 && (l = r.childNodes[i - 1]).nodeType == 1 && l.contentEditable == "false" && l.getBoundingClientRect().top >= e.top && i--, r == t.dom && i == r.childNodes.length - 1 && r.lastChild.nodeType == 1 && e.top > r.lastChild.getBoundingClientRect().bottom ? a = t.state.doc.content.size : (i == 0 || r.nodeType != 1 || r.childNodes[i - 1].nodeName != "BR") && (a = Q3(t, r, i, e));
  }
  a == null && (a = Y3(t, s, e));
...
function Bh(t, e, n) {
  ...
  if (r.nodeType == 3)
    if (s && (tv.test(r.nodeValue) || (n < 0 ? !i : i == r.nodeValue.length))) {
      let u = an($t(r, i, i), n);
...
function iv(t, e, n) {
  ...
  return a ? !rv.test(r.parent.textContent) || !a.modify ? n == "left" || n == "backward" ? o : s : Fh(t, e, () => {
...
function ov(t, e, n) {
  return Cd == e && Ad == n ? Sd : (Cd = e, Ad = n, Sd = n == "up" || n == "down" ? nv(t, e, n) : iv(t, e, n));
}
...
class Cn extends no {
  ...
  static create(e, n, r, i, o, s) {
    ...
    let f = c;
    return c = qh(c, r, n), l ? u = new av(e, n, r, i, c, d || null, f, l, o, s + 1) : n.isText ? new ua(e, n, r, i, c, f, o) : new Cn(e, n, r, i, c, d || null, f, o, s + 1);
  }
  parseRule() {
  ...
  // `this.children`.
  updateChildren(e, n) {
    let r = this.node.inlineContent, i = n, o = e.composing ? this.localCompositionInfo(e, n) : null, s = o && o.pos > -1 ? o : null, a = o && o.pos < 0, u = new lv(this, s && s.node, e);
    fv(this.node, this.innerDeco, (l, c, d) => {
    ...
    }), u.syncToMarks([], r, e), this.node.isTextblock && u.addTextblockHacks(), u.destroyRest(), (u.changed || this.dirty == jn) && (s && this.protectLocalComposition(e, s), jh(this.contentDOM, this.children, e), Br && pv(this.dom));
  }
  localCompositionInfo(e, n) {
    ...
    if (this.node.inlineContent) {
      let s = o.nodeValue, a = hv(this.node.content, s, r - n, i - n);
  ...
  updateOuterDeco(e) {
    ...
    this.dom = Wh(this.dom, this.nodeDOM, Vu(this.outerDeco, this.node, n), Vu(e, this.node, n)), this.dom != r && (r.pmViewDesc = void 0, this.dom.pmViewDesc = this), this.outerDeco = e;
  }
...
function qh(t, e, n) {
  return Wh(t, t, Wn, Vu(e, n, t.nodeType != 1));
}
function us(t, e) {
  if (t.length != e.length)
    return !1;
...
class lv {
  constructor(e, n, r) {
    this.lock = n, this.view = r, this.index = 0, this.stack = [], this.changed = !1, this.top = e, this.preMatch = cv(e.node.content, e);
  }
...
function Nl(t, e = null) {
  ...
  if (aa(n)) {
    for (u = s; i && !i.node; )
      i = i.parent;
    let d = i.node;
    if (i && d.isAtom && P.isSelectable(d) && i.parent && !(d.isInline && F3(n.focusNode, n.focusOffset, i.dom))) {
      let f = i.posBefore;
...
function Gt(t, e = !1) {
  ...
  if (Kh(t, n), !!Uh(t)) {
    ...
    if (t.domObserver.disconnectSelection(), t.cursorWrapper)
      ...
      Od && !(n instanceof I) && (n.$from.parent.inlineContent || (o = Nd(t, n.from)), !n.empty && !n.$from.parent.inlineContent && (s = Nd(t, n.to))), t.docView.setSelection(r, i, t, e), Od && (o && Ld(o), s && Ld(s)), n.visible ? t.dom.classList.remove("ProseMirror-hideselection") : (t.dom.classList.add("ProseMirror-hideselection"), "onselectionchange" in document && mv(t));
    }
...
function Du(t, e, n) {
  if (e.nodeType != 3) {
    let o, s;
    (s = wv(e, n)) ? (e = s, n = 0) : (o = xv(e, n)) && (e = o, n = o.nodeValue.length);
  }
...
function Dd(t, e) {
  ...
  if (!(Re || j3) && n.parent.inlineContent) {
...
function _d(t, e, n) {
  let r = t.state.selection;
  if (r instanceof I && !r.empty || n.indexOf("s") > -1 || nt && n.indexOf("m") > -1)
    return !1;
  let { $from: i, $to: o } = r;
...
function Zh(t, e) {
  ...
  let s = t.someProp("clipboardSerializer") || Nn.fromSchema(t.state.schema), a = n0(), u = a.createElement("div");
...
function Xh(t, e, n, r, i) {
  ...
  if (u) {
    if (t.someProp("transformPastedText", (f) => {
      ...
      return e ? new L(A.from(t.state.schema.text(e.replace(/\r\n?/g, `
`))), 0, 0) : L.empty;
  ...
  if (a || (a = (t.someProp("clipboardParser") || t.someProp("domParser") || xn.fromSchema(t.state.schema)).parseSlice(s, {
    ...
    context: i,
    ruleFromNode(f) {
      return f.nodeName == "BR" && !f.nextSibling && f.parentNode && !Sv.test(f.parentNode.nodeName) ? { ignore: !0 } : null;
    }
  })), c)
    a = Nv(Bd(a, +c[1], +c[2]), c[4]);
  else if (a = L.maxOpen(Tv(a.content, i), !0), a.openStart || a.openEnd) {
    let d = 0, f = 0;
...
const Sv = /^(a|abbr|acronym|b|cite|code|del|em|i|ins|kbd|label|output|q|ruby|s|samp|span|strong|sub|sup|time|u|tt|var)$/i;
function Tv(t, e) {
  if (t.childCount < 2)
    return t;
  for (let n = e.depth; n >= 0; n--) {
...
function Bd(t, e, n) {
  return e < t.openStart && (t = new L(_u(t.content, -1, e, t.openStart, 0, t.openEnd), e, t.openEnd)), n < t.openEnd && (t = new L(_u(t.content, 1, n, t.openEnd, 0, 0), t.openStart, n)), t;
}
const t0 = {
  thead: ["table"],
  tbody: ["table"],
...
function Ev(t) {
  ...
  if ((i = r && t0[r[1].toLowerCase()]) && (t = i.map((o) => "<" + o + ">").join("") + t + i.map((o) => "</" + o + ">").reverse().join("")), n.innerHTML = Mv(t), i)
    for (let o = 0; o < i.length; o++)
...
const Fe = {}, ze = {}, Lv = { touchstart: !0, touchmove: !0 };
class Vv {
  constructor() {
...
function Hv(t) {
  for (let e in Fe) {
    ...
    t.dom.addEventListener(e, t.input.eventHandlers[e] = (r) => {
      Dv(t, r) && !Vl(t, r) && (t.editable || !(r.type in ze)) && n(t, r);
    }, Lv[e] ? { passive: !0 } : void 0);
  }
...
ze.keydown = (t, e) => {
  ...
  if (t.input.shiftKey = n.keyCode == 16 || n.shiftKey, !i0(t, n) && (t.input.lastKeyCode = n.keyCode, t.input.lastKeyCodeTime = Date.now(), !(Wt && Re && n.keyCode == 13)))
    ...
    } else t.someProp("handleKeyDown", (r) => r(t, n)) || Av(t, n) ? n.preventDefault() : vn(t, "key");
};
ze.keyup = (t, e) => {
...
ze.keypress = (t, e) => {
  let n = e;
  if (i0(t, n) || !n.charCode || n.ctrlKey && !n.altKey || nt && n.metaKey)
    return;
...
function Fv(t, e, n, r, i) {
  return Hl(t, "handleClickOn", e, n, r) || t.someProp("handleClick", (o) => o(t, e, r)) || (i ? Bv(t, n) : Iv(t, n));
}
function zv(t, e, n, r) {
  return Hl(t, "handleDoubleClickOn", e, n, r) || t.someProp("handleDoubleClick", (i) => i(t, e, r));
}
function $v(t, e, n, r) {
  return Hl(t, "handleTripleClickOn", e, n, r) || t.someProp("handleTripleClick", (i) => i(t, e, r)) || jv(t, n, r);
}
function jv(t, e, n) {
  if (n.button != 0)
    return !1;
...
const r0 = nt ? "metaKey" : "ctrlKey";
Fe.mousedown = (t, e) => {
  let n = e;
  t.input.shiftKey = n.shiftKey;
  let r = Rl(t), i = Date.now(), o = "singleClick";
  i - t.input.lastClick.time < 500 && Pv(n, t.input.lastClick) && !n[r0] && (t.input.lastClick.type == "singleClick" ? o = "doubleClick" : t.input.lastClick.type == "doubleClick" && (o = "tripleClick")), t.input.lastClick = { time: i, x: n.clientX, y: n.clientY, type: o };
  let s = t.posAtCoords(la(n));
  s && (o == "singleClick" ? (t.input.mouseDown && t.input.mouseDown.done(), t.input.mouseDown = new Wv(t, s, n, !!r)) : (o == "doubleClick" ? zv : $v)(t, s.pos, s.inside, n) ? n.preventDefault() : vn(t, "pointer"));
};
class Wv {
  constructor(e, n, r, i) {
  ...
  up(e) {
    if (this.done(), !this.view.dom.contains(e.target))
      return;
    let n = this.pos;
    this.view.state.doc != this.startDoc && (n = this.view.posAtCoords(la(e))), this.updateAllowDefault(e), this.allowDefault || !n ? vn(this.view, "pointer") : Fv(this.view, n.pos, n.inside, e, this.selectNode) ? e.preventDefault() : e.button == 0 && (this.flushed || // Safari ignores clicks on draggable elements
...
function Uv(t) {
  ...
  if (!e.focusNode)
    return null;
  let n = I3(e.focusNode, e.focusOffset), r = B3(e.focusNode, e.focusOffset);
  if (n && r && n != r) {
...
const Fi = je && kn < 15 || Br && W3 < 604;
Fe.copy = ze.cut = (t, e) => {
  let n = e, r = t.state.selection, i = n.type == "cut";
  if (r.empty)
    return;
  let o = Fi ? null : n.clipboardData, s = r.content(), { dom: a, text: u } = Zh(t, s);
  o ? (n.preventDefault(), o.clearData(), o.setData("text/html", a.innerHTML), o.setData("text/plain", u)) : Gv(t, a), i && t.dispatch(t.state.tr.deleteSelection().scrollIntoView().setMeta("uiEvent", "cut"));
};
function Jv(t) {
...
function zi(t, e, n, r, i) {
  ...
  if (t.someProp("handlePaste", (u) => u(t, i, o || L.empty)))
    return !0;
  if (!o)
    return !1;
...
ze.paste = (t, e) => {
  ...
  r && zi(t, a0(r), r.getData("text/html"), i, n) ? n.preventDefault() : Zv(t, n);
};
class u0 {
  constructor(e, n, r) {
...
ze.drop = (t, e) => {
  ...
  if (d && P.isSelectable(s.content.firstChild) && p.nodeAfter && p.nodeAfter.sameMarkup(s.content.firstChild))
    ...
    l.mapping.maps[l.mapping.maps.length - 1].forEach((m, g, b, x) => h = x), l.setSelection(Ll(t, p, l.doc.resolve(h)));
  }
...
class oe {
  ...
  */
  mapInner(e, n, r, i, o) {
    ...
    return this.children.length ? Xv(this.children, s || [], e, n, r, i, o) : s ? new oe(s.sort(Zn), Cr) : He;
  }
  /**
...
function Xv(t, e, n, r, i, o, s) {
  ...
  if (u) {
    let l = Yv(a, t, e, n, i, o, s), c = fs(l, r, 0, s);
    e = c.local;
...
class n6 {
  constructor(e, n) {
    this.view = e, this.handleDOMChange = n, this.queue = [], this.flushingSoon = -1, this.observer = null, this.currentSelection = new t6(), this.onCharData = null, this.suppressingSelectionUpdates = !1, this.lastChangedTextNode = null, this.observer = window.MutationObserver && new window.MutationObserver((r) => {
      for (let i = 0; i < r.length; i++)
        this.queue.push(r[i]);
  ...
  start() {
    this.observer && (this.observer.takeRecords(), this.observer.observe(this.view.dom, Qv)), this.onCharData && this.view.dom.addEventListener("DOMCharacterDataModified", this.onCharData), this.connectSelection();
  }
  stop() {
    if (this.observer) {
  ...
  flush() {
    ...
    if (mt && u.length) {
      ...
      if (c.length == 2) {
        ...
        for (let f of c) {
          let p = f.parentNode;
          p && p.nodeName == "LI" && (!d || o6(e, d) != p) && f.remove();
        }
      }
    }
    let l = null;
    o < 0 && i && e.input.lastFocus > Date.now() - 200 && Math.max(e.input.lastTouch, e.input.lastClick.time) < Date.now() - 300 && aa(r) && (l = Nl(e)) && l.eq(F.near(e.state.doc.resolve(0), 1)) ? (e.input.lastFocus = 0, Gt(e), this.currentSelection.set(r), e.scrollToSelection()) : (o > -1 || i) && (o > -1 && (e.docView.markDirty(o, s), r6(e)), this.handleDOMChange(o, s, a, u), e.docView && e.docView.dirty ? e.updateState(e.state) : this.currentSelection.eq(r) || Gt(e), this.currentSelection.set(r));
  }
...
const u6 = /^(a|abbr|acronym|b|bd[io]|big|br|button|cite|code|data(list)?|del|dfn|em|i|ins|kbd|label|map|mark|meter|output|q|ruby|s|samp|small|span|strong|su[bp]|time|u|tt|var)$/i;
function l6(t, e, n, r, i) {
  ...
  let u = t.state.selection, l = s6(t, e, n), c = t.state.doc, d = c.slice(l.from, l.to), f, p;
  ...
  let h = f6(d.content, l.doc.content, l.from, f, p);
  if (h && t.input.domChangeCount++, (Br && t.input.lastIOSEnter > Date.now() - 225 || Wt) && i.some((O) => O.nodeType == 1 && !u6.test(O.nodeName)) && (!h || h.endA >= h.endB) && t.someProp("handleKeyDown", (O) => O(t, zn(13, "Enter")))) {
  ...
  if (t.state.selection.anchor > h.start && d6(c, h.start, h.endA, m, g) && t.someProp("handleKeyDown", (O) => O(t, zn(8, "Backspace")))) {
  ...
  if (x) {
    if (m.pos == g.pos)
      je && kn <= 11 && m.parentOffset == 0 && (t.domObserver.suppressSelectionUpdates(), setTimeout(() => Gt(t), 20)), v = t.state.tr.delete(y, k), E = c.resolve(h.start).marksAcross(c.resolve(h.endA));
    else if (
      // Adding or removing a mark
      h.endA == h.endB && (M = c6(m.parent.content.cut(m.parentOffset, g.parentOffset), b.parent.content.cut(b.parentOffset, h.endA - b.start())))
    )
...
function qd(t, e, n) {
  return Math.max(n.anchor, n.head) > e.content.size ? null : Ll(t, e.resolve(n.anchor), e.resolve(n.head));
}
function c6(t, e) {
...
class p6 {
  ...
  */
  ...
  updateStateInner(e, n) {
    ...
    if (a || this._props.plugins != n.plugins || this._props.nodeViews != n.nodeViews) {
      let p = Zd(this);
      m6(p, this.nodeViews) && (this.nodeViews = p, o = !0);
    }
    ...
    let f = c == "preserve" && s && this.dom.style.overflowAnchor == null && K3(this);
    if (s) {
      this.domObserver.stop();
      let p = d && (je || Re) && !this.composing && !i.selection.empty && !e.selection.empty && h6(i.selection, e.selection);
      if (d) {
        let h = Re ? this.trackWrites = this.domSelectionRange().focusNode : null;
        this.composing && (this.input.compositionNode = Uv(this)), (o || !this.docView.update(e.doc, l, u, this)) && (this.docView.updateOuterDeco(l), this.docView.destroy(), this.docView = Md(e.doc, l, u, this.dom, this)), h && !this.trackWrites && (p = !0);
      }
      p || !(this.input.mouseDown && this.domObserver.currentSelection.eq(this.domSelectionRange()) && bv(this)) ? Gt(this, p) : (Kh(this, e.selection), this.domObserver.setCurSelection()), this.domObserver.start();
    }
    this.updatePluginViews(i), !((r = this.dragging) === null || r === void 0) && r.node && !i.doc.eq(e.doc) && this.updateDraggedNode(this.dragging, i), c == "reset" ? this.dom.scrollTop = 0 : c == "to selection" ? this.scrollToSelection() : f && G3(f);
  }
  /**
  @internal
  */
  ...
  */
  focus() {
    this.domObserver.stop(), this.editable && J3(this.dom), Gt(this), this.domObserver.start();
  }
  /**
  ...
  */
  destroy() {
    this.docView && (Rv(this), this.destroyPluginViews(), this.mounted ? (this.docView.update(this.state.doc, [], $a(this), this), this.dom.textContent = "") : this.dom.parentNode && this.dom.parentNode.removeChild(this.dom), this.docView.destroy(), this.docView = null, _3());
  }
  /**
  ...
  */
  domSelectionRange() {
    ...
    return e ? Be && this.root.nodeType === 11 && z3(this.dom.ownerDocument) == this.dom && i6(this, e) || e : { focusNode: null, focusOffset: 0, anchorNode: null, anchorOffset: 0 };
  }
  /**
  @internal
  */
...
var Tn = {
  ...
  221: "}",
  222: '"'
}, g6 = typeof navigator < "u" && /Mac/.test(navigator.platform), b6 = typeof navigator < "u" && /MSIE \d|Trident\/(?:[7-9]|\d{2,})\..*rv:(\d+)/.exec(navigator.userAgent);
...
function y6(t) {
  var e = g6 && t.metaKey && t.shiftKey && !t.ctrlKey && !t.altKey || b6 && t.shiftKey && t.key && t.key.length == 1 || t.key == "Unidentified", n = !e && t.key || (t.shiftKey ? ps : Tn)[t.keyCode] || t.key || "Unidentified";
  return n == "Esc" && (n = "Escape"), n == "Del" && (n = "Delete"), n == "Left" && (n = "ArrowLeft"), n == "Up" && (n = "ArrowUp"), n == "Right" && (n = "ArrowRight"), n == "Down" && (n = "ArrowDown"), n;
}
const v6 = typeof navigator < "u" ? /Mac|iP(hone|[oa]d)/.test(navigator.platform) : !1;
function w6(t) {
...
const C6 = (t, e, n) => {
  ...
  if (r.parent.content.size == 0 && (Fr(o, "end") || P.isSelectable(o)))
    for (let s = r.depth; ; s--) {
      let a = oa(t.doc, r.before(s), r.after(s), L.empty);
...
const M6 = (t, e, n) => {
  ...
  if (r.parent.content.size == 0 && (Fr(o, "start") || P.isSelectable(o))) {
    let s = oa(t.doc, r.before(), r.after(), L.empty);
...
function y0(t, e, n, r) {
  ...
  if (l && (s = (a = i.contentMatchAt(i.childCount)).findWrapping(o.type)) && a.matchType(s[0] || o.type).validEnd) {
    if (n) {
      ...
      h = A.from(i.copy(h));
      let m = t.tr.step(new Ae(e.pos - 1, p, e.pos, p, new L(h, 1, 0), s.length, !0)), g = m.doc.resolve(p + 2 * s.length);
    ...
    if (p.canReplace(p.childCount, p.childCount, m.content)) {
      if (n) {
        ...
        for (let w = h.length - 1; w >= 0; w--)
          b = A.from(h[w].copy(b));
        let x = t.tr.step(new Ae(e.pos - h.length, e.pos + o.nodeSize, e.pos + g, e.pos + o.nodeSize - g, new L(b, h.length, 0), 0, !0));
        n(x.scrollIntoView());
      }
      return !0;
    }
...
function z6(t, e = null) {
  return function(n, r) {
    let { $from: i, $to: o } = n.selection, s = i.blockRange(o);
    if (!s)
      return !1;
    let a = r ? n.tr : null;
    return $6(a, s, t, e) ? (r && r(a.scrollIntoView()), !0) : !1;
  };
}
function $6(t, e, n, r = null) {
  ...
  let a = Tl(o, n, r, e);
  return a ? (t && j6(t, e, a, i, n), !0) : !1;
}
function j6(t, e, n, r, i) {
  let o = A.empty;
  for (let c = n.length - 1; c >= 0; c--)
    o = A.from(n[c].type.create(n[c].attrs, o));
  t.step(new Ae(e.start - (r ? 2 : 0), e.end, e.start, e.end, new L(o, 0, 0), n.length, !0));
  let s = 0;
  for (let c = 0; c < n.length; c++)
    n[c].type == i && (s = c + 1);
...
function W6(t) {
  return function(e, n) {
    ...
    return o ? n ? r.node(o.depth - 1).type == t ? q6(e, n, t, o) : U6(e, n, o) : !0 : !1;
  };
}
function q6(t, e, n, r) {
  let i = t.tr, o = r.end, s = r.$to.end(r.depth);
  o < s && (i.step(new Ae(o - 1, s, o, s, new L(A.from(n.create(null, r.parent.copy())), 1, 0), 1, !0)), r = new ss(i.doc.resolve(r.$from.pos), i.doc.resolve(s), r.depth));
  const a = Yr(r);
  if (a == null)
    return !1;
  i.lift(r, a);
...
function U6(t, e, n) {
  ...
  return r.step(new Ae(d - (a ? 1 : 0), f + (u ? 1 : 0), d + 1, f - 1, new L((a ? A.empty : A.from(i.copy(A.empty))).append(u ? A.empty : A.from(i.copy(A.empty))), a ? 0 : 1, u ? 0 : 1), a ? 0 : 1)), e(r.scrollIntoView()), !0;
}
function K6(t) {
  return function(e, n) {
    ...
    if (u.type != t)
      return !1;
    if (n) {
      let l = u.lastChild && u.lastChild.type == a.type, c = A.from(l ? t.create() : null), d = new L(A.from(t.create(null, A.from(a.type.create(null, c)))), l ? 3 : 1, 0), f = o.start, p = o.end;
  ...
  return "style" in t ? t : {
    ...
    getAttrs: (n) => {
      ...
      const i = e.reduce((o, s) => {
        const a = s.attribute.parseHTML ? s.attribute.parseHTML(n) : Z6(n.getAttribute(s.name));
        return a == null ? o : {
          ...o,
          [s.name]: a
        };
...
function So(t) {
  return e4(t) !== "Object" ? !1 : t.constructor === Object && Object.getPrototypeOf(t) === Object.prototype;
}
function ha(t, e) {
  const n = { ...t };
  ...
  return n.map((c) => new se({
    ...
    appendTransaction: (d, f, p) => {
      ...
      if (x) {
        ...
        const { from: v } = b, E = v + k.length, M = o4(k);
        return u({
          rule: c,
          state: p,
          from: v,
...
class qn {
   ...
   */
  static resolve(e) {
    const n = qn.sort(qn.flatten(e)), r = a4(n.map((i) => i.name));
  ...
  get plugins() {
    const { editor: e } = this, n = qn.sort([...this.extensions].reverse()), r = [], i = [], o = n.map((s) => {
      ...
      let c = {};
      if (s.type === "mark" && R(s, "exitable", a) && (c.ArrowRight = () => Ue.handleExit({ editor: e, mark: s })), l) {
...
const u4 = /* @__PURE__ */ ne.create({
...
}), l4 = () => ({ editor: t, view: e }) => (requestAnimationFrame(() => {
  var n;
  t.isDestroyed || (e.dom.blur(), (n = window == null ? void 0 : window.getSelection()) === null || n === void 0 || n.removeAllRanges());
}), !0), c4 = (t = !1) => ({ commands: e }) => e.setContent("", t), d4 = () => ({ state: t, tr: e, dispatch: n }) => {
...
}, f4 = (t) => (e) => t(e), p4 = () => ({ state: t, dispatch: e }) => R6(t, e), h4 = (t, e) => ({ editor: n, tr: r }) => {
  ...
  return !1;
}, b4 = (t) => ({ tr: e, dispatch: n }) => {
  const { from: r, to: i } = t;
  return n && e.delete(r, i), !0;
}, y4 = () => ({ state: t, dispatch: e }) => p0(t, e), v4 = () => ({ commands: t }) => t.keyboardShortcut("Enter"), w4 = () => ({ state: t, dispatch: e }) => H6(t, e);
...
const x4 = (t, e = {}) => ({ tr: n, state: r, dispatch: i }) => {
...
const C4 = (t = null, e = {}) => ({ editor: n, view: r, tr: i, dispatch: o }) => {
  e = {
    scrollIntoView: !0,
    ...e
  };
...
}, A4 = (t, e) => (n) => t.every((r, i) => e(r, { ...n, index: i })), S4 = (t, e) => ({ tr: n, commands: r }) => r.insertContentAt({ from: n.selection.from, to: n.selection.to }, t, e), M0 = (t) => {
...
const M4 = (t) => !("type" in t), E4 = (t, e, n) => ({ tr: r, dispatch: i, editor: o }) => {
  var s;
  if (i) {
    n = {
    ...
    n.updateSelection && T4(r, r.steps.length - 1, -1), n.applyInputRules && r.setMeta("applyInputRules", { from: u, text: p }), n.applyPasteRules && r.setMeta("applyPasteRules", { from: u, text: p });
  }
  return !0;
}, O4 = () => ({ state: t, dispatch: e }) => O6(t, e), N4 = () => ({ state: t, dispatch: e }) => N6(t, e), L4 = () => ({ state: t, dispatch: e }) => C6(t, e), V4 = () => ({ state: t, dispatch: e }) => M6(t, e), H4 = () => ({ state: t, dispatch: e, tr: n }) => {
  try {
...
}, D4 = () => ({ state: t, dispatch: e }) => A6(t, e), _4 = () => ({ state: t, dispatch: e }) => S6(t, e);
function E0() {
...
const I4 = (t) => ({ editor: e, view: n, tr: r, dispatch: i }) => {
  const o = P4(t).split(/-(?!$)/), s = o.find((l) => !["Alt", "Ctrl", "Meta", "Shift"].includes(l)), a = new KeyboardEvent("keydown", {
    key: s === "Space" ? " " : s,
...
const B4 = (t, e = {}) => ({ state: n, dispatch: r }) => {
  const i = Te(t, n.schema);
  return ji(n, i, e) ? L6(n, r) : !1;
}, F4 = () => ({ state: t, dispatch: e }) => D6(t, e), z4 = (t) => ({ state: e, dispatch: n }) => {
  const r = Te(t, e.schema);
  return W6(r)(e, n);
}, $4 = () => ({ state: t, dispatch: e }) => V6(t, e);
function ba(t, e) {
...
const j4 = (t, e) => ({ tr: n, state: r, dispatch: i }) => {
  let o = null, s = null;
...
}, W4 = () => ({ tr: t, dispatch: e }) => (e && t.scrollIntoView(), !0), q4 = () => ({ tr: t, dispatch: e }) => {
  if (e) {
    const n = new st(t.doc);
    t.setSelection(n);
  }
  return !0;
}, U4 = () => ({ state: t, dispatch: e }) => T6(t, e), K4 = () => ({ state: t, dispatch: e }) => E6(t, e), G4 = () => ({ state: t, dispatch: e }) => _6(t, e), J4 = () => ({ state: t, dispatch: e }) => B6(t, e), Z4 = () => ({ state: t, dispatch: e }) => I6(t, e);
function Bu(t, e, n = {}, r = {}) {
  return ms(t, e, {
    slice: !1,
    parseOptions: n,
...
const X4 = (t, e = !1, n = {}, r = {}) => ({ editor: i, tr: o, dispatch: s, commands: a }) => {
  var u, l;
  const { doc: c } = o;
...
function V0(t, e) {
  ...
  return n === "node" ? nw(t, e) : n === "mark" ? O0(t, e) : {};
}
function rw(t, e = JSON.stringify) {
  const n = {};
  return t.filter((r) => {
    const i = e(r);
...
const uw = (t, e = {}) => ({ tr: n, state: r, dispatch: i }) => {
  ...
  return aw(r, n, u);
}, lw = (t, e) => ({ tr: n }) => (n.setMeta(t, e), !0), cw = (t, e = {}) => ({ state: n, dispatch: r, chain: i }) => {
...
const hw = ({ keepMarks: t = !0 } = {}) => ({ tr: e, state: n, dispatch: r, editor: i }) => {
  ...
  if (o instanceof P && o.node.isBlock)
    return !a.parentOffset || !Vr(s, a.pos) ? !1 : (r && (t && sf(n, i.extensionManager.splittableMarks), e.split(a.pos).scrollIntoView()), !0);
  if (!a.parent.isBlock)
    return !1;
  const d = u.parentOffset === u.parent.content.size, f = a.depth === 0 ? void 0 : Q4(a.node(-1).contentMatchAt(a.indexAfter(-1)));
  let p = d && f ? [
    {
      type: f,
      attrs: c
  ...
  return h;
}, mw = (t, e = {}) => ({ tr: n, state: r, dispatch: i, editor: o }) => {
  var s;
  ...
  if (u.parent.content.size === 0 && u.node(-1).childCount === u.indexAfter(-1)) {
    ...
    if (i) {
      ...
      n.replace(v, u.after(-w), new L(b, 4 - x, 0));
      let E = -1;
...
}, gw = (t, e, n, r = {}) => ({ editor: i, tr: o, state: s, dispatch: a, chain: u, commands: l, can: c }) => {
...
}, vw = (t, e = {}) => ({ state: n, commands: r }) => {
  const i = Te(t, n.schema);
  return ji(n, i, e) ? r.lift(i) : r.wrapIn(i, e);
}, ww = () => ({ state: t, dispatch: e }) => {
  const n = t.plugins;
  for (let r = 0; r < n.length; r += 1) {
    const i = n[r];
    let o;
...
}, kw = (t, e = {}) => ({ tr: n, state: r, dispatch: i }) => {
  var o;
...
}, Aw = (t, e = {}) => ({ state: n, dispatch: r }) => {
  const i = Te(t, n.schema);
  return F6(i, e)(n, r);
}, Sw = (t, e = {}) => ({ state: n, dispatch: r }) => {
  const i = Te(t, n.schema);
  return z6(i, e)(n, r);
};
var Tw = /* @__PURE__ */ Object.freeze({
  ...
  joinItemBackward: H4,
  joinItemForward: R4,
  joinTextblockBackward: D4,
  joinTextblockForward: _4,
  joinUp: O4,
  keyboardShortcut: I4,
  lift: B4,
  liftEmptyBlock: F4,
  ...
  scrollIntoView: W4,
  selectAll: q4,
  selectNodeBackward: U4,
  selectNodeForward: K4,
  selectParentNode: G4,
  selectTextblockEnd: J4,
  selectTextblockStart: Z4,
  setContent: X4,
  setMark: uw,
  setMeta: lw,
  setNode: cw,
...
var We = "top", ct = "bottom", dt = "right", qe = "left", Ul = "auto", ro = [We, ct, dt, qe], $r = "start", Wi = "end", Iw = "clippingParents", _0 = "viewport", ui = "popper", Bw = "reference", af = /* @__PURE__ */ ro.reduce(function(t, e) {
  return t.concat([e + "-" + $r, e + "-" + Wi]);
}, []), P0 = /* @__PURE__ */ [].concat(ro, [Ul]).reduce(function(t, e) {
  return t.concat([e, e + "-" + $r, e + "-" + Wi]);
}, []), Fw = "beforeRead", zw = "read", $w = "afterRead", jw = "beforeMain", Ww = "main", qw = "afterMain", Uw = "beforeWrite", Kw = "write", Gw = "afterWrite", Jw = [Fw, zw, $w, jw, Ww, qw, Uw, Kw, Gw];
function Nt(t) {
...
function Zw(t) {
  ...
  Object.keys(e.elements).forEach(function(n) {
    ...
    !ut(o) || !Nt(o) || (Object.assign(o.style, r), Object.keys(i).forEach(function(s) {
      var a = i[s];
...
function Xw(t) {
  ...
  return Object.assign(e.elements.popper.style, n.popper), e.styles = n, e.elements.arrow && Object.assign(e.elements.arrow.style, n.arrow), function() {
    Object.keys(e.elements).forEach(function(r) {
      ...
      !ut(i) || !Nt(i) || (Object.assign(i.style, a), Object.keys(o).forEach(function(u) {
        i.removeAttribute(u);
      }));
    });
  };
...
function Wr(t, e, n) {
  ...
  var s = sr(t) ? Xe(t) : window, a = s.visualViewport, u = !B0() && n, l = (r.left + (u && a ? a.offsetLeft : 0)) / i, c = (r.top + (u && a ? a.offsetTop : 0)) / o, d = r.width / i, f = r.height / o;
  return {
    width: d,
    height: f,
    top: c,
...
function Qw(t) {
  ...
  var i = va(t);
  for (Kl(i) && (i = i.host); ut(i) && ["html", "body"].indexOf(Nt(i)) < 0; ) {
    var o = Yt(i);
...
function io(t) {
  for (var e = Xe(t), n = uf(t); n && Yw(n) && Yt(n).position === "static"; )
    n = uf(n);
  return n && (Nt(n) === "html" || Nt(n) === "body" && Yt(n).position === "static") ? e : n || Qw(t) || e;
}
function Jl(t) {
...
function nx(t) {
  var e, n = t.state, r = t.name, i = t.options, o = n.elements.arrow, s = n.modifiersData.popperOffsets, a = Tt(n.placement), u = Jl(a), l = [qe, dt].indexOf(a) >= 0, c = l ? "height" : "width";
  if (!(!o || !s)) {
    var d = tx(i.padding, n), f = Gl(o), p = u === "y" ? We : qe, h = u === "y" ? ct : dt, m = n.rects.reference[c] + n.rects.reference[u] - s[u] - n.rects.popper[c], g = s[u] - n.rects.reference[u], b = io(o), x = b ? u === "y" ? b.clientHeight || 0 : b.clientWidth || 0 : 0, w = m / 2 - g / 2, y = d[p], k = x - f[c] - d[h], v = x / 2 - f[c] / 2 + w, E = Ci(y, v, k), M = u;
...
function lf(t) {
  ...
  if (l) {
    ...
    if (v === Xe(n) && (v = Rn(n), Yt(v).position !== "static" && a === "absolute" && (E = "scrollHeight", M = "scrollWidth")), v = v, i === We || (i === qe || i === dt) && o === Wi) {
      y = ct;
...
function lx(t) {
  var e = t.state, n = t.instance, r = t.options, i = r.scroll, o = i === void 0 ? !0 : i, s = r.resize, a = s === void 0 ? !0 : s, u = Xe(e.elements.popper), l = [].concat(e.scrollParents.reference, e.scrollParents.popper);
...
function Zl(t) {
  var e = Xe(t), n = e.pageXOffset, r = e.pageYOffset;
  return {
    scrollLeft: n,
    scrollTop: r
  };
...
function px(t, e) {
  var n = Xe(t), r = Rn(t), i = n.visualViewport, o = r.clientWidth, s = r.clientHeight, a = 0, u = 0;
  if (i) {
...
function W0(t) {
  return ["html", "body", "#document"].indexOf(Nt(t)) >= 0 ? t.ownerDocument.body : ut(t) && Yl(t) ? t : W0(va(t));
}
function Ai(t, e) {
  var n;
  e === void 0 && (e = []);
  var r = W0(t), i = r === ((n = t.ownerDocument) == null ? void 0 : n.body), o = Xe(r), s = i ? [o].concat(o.visualViewport || [], Yl(r) ? r : []) : r, a = e.concat(s);
  return i ? a : (
...
function df(t, e, n) {
  return e === _0 ? ju(px(t, n)) : sr(e) ? mx(e, n) : ju(hx(Rn(t)));
}
function gx(t) {
  var e = Ai(va(t)), n = ["absolute", "fixed"].indexOf(Yt(t).position) >= 0, r = n && ut(t) ? io(t) : t;
  return sr(r) ? e.filter(function(i) {
    return sr(i) && F0(i, r) && Nt(i) !== "body";
  }) : [];
}
function bx(t, e, n, r) {
  var i = e === "clippingParents" ? gx(t) : [].concat(e), o = [].concat(i, [n]), s = o[0], a = o.reduce(function(u, l) {
    var c = df(t, l, r);
...
function qi(t, e) {
  e === void 0 && (e = {});
  var n = e, r = n.placement, i = r === void 0 ? t.placement : r, o = n.strategy, s = o === void 0 ? t.strategy : o, a = n.boundary, u = a === void 0 ? Iw : a, l = n.rootBoundary, c = l === void 0 ? _0 : l, d = n.elementContext, f = d === void 0 ? ui : d, p = n.altBoundary, h = p === void 0 ? !1 : p, m = n.padding, g = m === void 0 ? 0 : m, b = $0(typeof g != "number" ? g : j0(g, ro)), x = f === ui ? Bw : ui, w = t.rects.popper, y = t.elements[h ? x : f], k = bx(sr(y) ? y : y.contextElement || Rn(t.elements.popper), u, c, s), v = Wr(t.elements.reference), E = q0({
    reference: v,
    element: w,
    strategy: "absolute",
    placement: i
  ...
  if (f === ui && _) {
    ...
    Object.keys(B).forEach(function(K) {
      var we = [dt, ct].indexOf(K) >= 0 ? 1 : -1, ye = [We, ct].indexOf(K) >= 0 ? "y" : "x";
      B[K] += U[ye] * we;
    });
  }
  return B;
...
function wx(t) {
  ...
  if (!e.modifiersData[r]._skip) {
    for (var i = n.mainAxis, o = i === void 0 ? !0 : i, s = n.altAxis, a = s === void 0 ? !0 : s, u = n.fallbackPlacements, l = n.padding, c = n.boundary, d = n.rootBoundary, f = n.altBoundary, p = n.flipVariations, h = p === void 0 ? !0 : p, m = n.allowedAutoPlacements, g = e.options.placement, b = Tt(g), x = b === g, w = u || (x || !h ? [Uo(g)] : vx(g)), y = [g].concat(w).reduce(function(Ht, ft) {
      return Ht.concat(Tt(ft) === Ul ? yx(e, {
        placement: ft,
        boundary: c,
        rootBoundary: d,
        padding: l,
      ...
      var _ = y[B], U = Tt(_), K = qr(_) === $r, we = [We, ct].indexOf(U) >= 0, ye = we ? "width" : "height", le = qi(e, {
        placement: _,
        boundary: c,
        rootBoundary: d,
        altBoundary: f,
        padding: l
      }), pe = we ? K ? dt : qe : K ? ct : We;
      k[ye] > v[ye] && (pe = Uo(pe));
      var Me = Uo(pe), bt = [];
      if (o && bt.push(le[U] <= 0), a && bt.push(le[pe] <= 0, le[Me] <= 0), bt.every(function(Ht) {
        return Ht;
      })) {
        O = _, M = !1;
        break;
...
function pf(t) {
  return [We, dt, ct, qe].some(function(e) {
    return t[e] >= 0;
  });
}
function kx(t) {
...
function Ax(t, e, n) {
  var r = Tt(t), i = [qe, We].indexOf(r) >= 0 ? -1 : 1, o = typeof n == "function" ? n(Object.assign({}, e, {
    placement: t
  })) : n, s = o[0], a = o[1];
  return s = s || 0, a = (a || 0) * i, [qe, dt].indexOf(r) >= 0 ? {
    x: a,
    y: s
  } : {
    x: s,
...
function Nx(t) {
  var e = t.state, n = t.options, r = t.name, i = n.mainAxis, o = i === void 0 ? !0 : i, s = n.altAxis, a = s === void 0 ? !1 : s, u = n.boundary, l = n.rootBoundary, c = n.altBoundary, d = n.padding, f = n.tether, p = f === void 0 ? !0 : f, h = n.tetherOffset, m = h === void 0 ? 0 : h, g = qi(e, {
    ...
    padding: d,
    altBoundary: c
  }), b = Tt(e.placement), x = qr(e.placement), w = !x, y = Jl(b), k = Ox(y), v = e.modifiersData.popperOffsets, E = e.rects.reference, M = e.rects.popper, O = typeof m == "function" ? m(Object.assign({}, e.rects, {
    placement: e.placement
  })) : m, B = typeof O == "number" ? {
    mainAxis: O,
    altAxis: O
  ...
  if (v) {
    if (o) {
      var K, we = y === "y" ? We : qe, ye = y === "y" ? ct : dt, le = y === "y" ? "height" : "width", pe = v[y], Me = pe + g[we], bt = pe - g[ye], yt = p ? -M[le] / 2 : 0, Dn = x === $r ? E[le] : M[le], vt = x === $r ? -M[le] : -E[le], _n = e.elements.arrow, Ht = p && _n ? Gl(_n) : {
        width: 0,
        height: 0
      }, ft = e.modifiersData["arrow#persistent"] ? e.modifiersData["arrow#persistent"].padding : z0(), Rt = ft[we], fr = ft[ye], Dt = Ci(0, E[le], Ht[le]), pr = w ? E[le] / 2 - yt - Dt - Rt - B.mainAxis : Dn - Dt - Rt - B.mainAxis, rn = w ? -E[le] / 2 + yt + Dt + fr + B.mainAxis : vt + Dt + fr + B.mainAxis, hr = e.elements.arrow && io(e.elements.arrow), so = hr ? y === "y" ? hr.clientTop || 0 : hr.clientLeft || 0 : 0, ti = (K = _ == null ? void 0 : _[y]) != null ? K : 0, ao = pe + pr - ti - so, uo = pe + rn - ti, ni = Ci(p ? gs(Me, ao) : Me, pe, p ? Xn(bt, uo) : bt);
      v[y] = ni, U[y] = ni - pe;
    }
    if (a) {
      var ri, lo = y === "x" ? We : qe, co = y === "x" ? ct : dt, _t = v[k], on = k === "y" ? "height" : "width", ii = _t + g[lo], Pn = _t - g[co], oi = [We, qe].indexOf(b) !== -1, fo = (ri = _ == null ? void 0 : _[k]) != null ? ri : 0, po = oi ? ii : _t - E[on] - M[on] - fo + B.altAxis, ho = oi ? _t + E[on] + M[on] - fo - B.altAxis : Pn, mo = p && oi ? ex(po, _t, ho) : Ci(p ? po : ii, _t, p ? ho : Pn);
      v[k] = mo, U[k] = mo - _t;
    }
    e.modifiersData[r] = U;
  }
...
function Dx(t, e, n) {
  n === void 0 && (n = !1);
  var r = ut(e), i = ut(e) && Rx(e), o = Rn(e), s = Wr(t, i, n), a = {
    scrollLeft: 0,
    scrollTop: 0
  }, u = {
    x: 0,
  ...
  Yl(o)) && (a = Hx(e)), ut(e) ? (u = Wr(e, !0), u.x += e.clientLeft, u.y += e.clientTop) : o && (u.x = Xl(o))), {
  ...
  return function(a, u, l) {
    ...
    var c = {
      ...
      setOptions: function(b) {
        ...
        var w = Px(Bx([].concat(r, c.options.modifiers)));
      ...
      forceUpdate: function() {
        if (!f) {
          ...
          if (mf(x, w)) {
            c.rects = {
              reference: Dx(x, io(w), c.options.strategy === "fixed"),
              popper: Gl(w)
...
var zx = [cx, Ex, ux, I0, Tx, xx, Lx, ix, Cx], $x = /* @__PURE__ */ Fx({
  defaultModifiers: zx
}), jx = "tippy-box", U0 = "tippy-content", Wx = "tippy-backdrop", K0 = "tippy-arrow", G0 = "tippy-svg-arrow", Fn = {
  passive: !0,
  capture: !0
}, J0 = function() {
...
function Qx(t) {
  return Ui(t) ? [t] : Zx(t) ? bs(t) : Array.isArray(t) ? t : bs(document.querySelectorAll(t));
}
function Za(t, e) {
...
function t5(t, e) {
  ...
  return t.every(function(i) {
    var o = i.popperRect, s = i.popperState, a = i.props, u = a.interactiveBorder, l = Jx(s.placement), c = s.modifiersData.offset;
    if (!c)
      return !0;
...
function i5() {
  document.addEventListener("touchstart", n5, Fn), window.addEventListener("blur", r5);
}
var o5 = typeof window < "u" && typeof document < "u", s5 = o5 ? (
  // @ts-ignore
  !!window.msCrypto
) : !1;
function wr(t) {
...
var Ki;
process.env.NODE_ENV !== "production" && u5();
function u5() {
  Ki = /* @__PURE__ */ new Set();
}
function jt(t, e) {
...
var Q0 = {
  ...
  triggerTarget: null
}, Q0, c5), d5 = Object.keys(Ge), f5 = function(e) {
...
function p5(t, e) {
  var n = e ? Object.keys(e1(Object.assign({}, Ge, {
    plugins: e
  }))) : d5, r = n.reduce(function(i, o) {
...
function Cf(t, e) {
  ...
  }, e.ignoreAttributes ? {} : p5(t, e.plugins));
...
function t1(t, e) {
  ...
  var n = Object.keys(t);
  n.forEach(function(r) {
    var i = Ux(Ge, Object.keys(Q0)), o = !qx(i, r);
...
function Uu(t) {
  ...
  return {
    ...
    backdrop: n.find(function(r) {
      return r.classList.contains(Wx);
    })
  };
}
function n1(t) {
  var e = Si(), n = Si();
  n.className = jx, n.setAttribute("data-state", "hidden"), n.setAttribute("tabindex", "-1");
  var r = Si();
...
var m5 = 1, Oo = [], Ya = [];
function g5(t, e) {
  var n = Cf(t, Object.assign({}, Ge, e1(yf(e)))), r, i, o, s = !1, a = !1, u = !1, l = !1, c, d, f, p = [], h = gf(ao, n.interactiveDebounce), m, g = m5++, b = null, x = Gx(n.plugins), w = {
  ...
  function we() {
    var C = K().parentNode;
    return C ? e5(C) : document;
  }
  function ye() {
    return Uu(v);
  }
  function le(C) {
    return y.state.isMounted && !y.state.isVisible || Ct.isTouch || c && c.type === "focus" ? 0 : Ja(y.props.delay, C ? 0 : 1, Ge.delay);
  }
  function pe(C) {
    ...
    if (C.content) {
      ...
      Y.forEach(function(G) {
        ...
        if (y.state.isVisible)
          ...
          var Ye = Ie && Ie.replace(z, "").trim();
          Ye ? G.setAttribute(D, Ye) : G.removeAttribute(D);
        }
      });
    }
  }
  ...
  function ft() {
    var C = we();
    C.addEventListener("mousedown", vt, !0), C.addEventListener("touchend", vt, Fn), C.addEventListener("touchstart", Ht, Fn), C.addEventListener("touchmove", _n, Fn);
  }
  function Rt() {
    var C = we();
    C.removeEventListener("mousedown", vt, !0), C.removeEventListener("touchend", vt, Fn), C.removeEventListener("touchstart", Ht, Fn), C.removeEventListener("touchmove", _n, Fn);
  }
  function fr(C, D) {
    pr(C, function() {
  ...
  function hr() {
    _() && (rn("touchstart", ti, {
      ...
      passive: !0
    })), Kx(y.props.trigger).forEach(function(C) {
      if (C !== "manual")
        switch (rn(C, ti), C) {
          case "mouseenter":
            rn("mouseleave", uo);
  ...
  function ti(C) {
    ...
    if (!(!y.state.isEnabled || ri(C) || a)) {
      ...
      c = C, m = C.currentTarget, yt(), !y.state.isVisible && Xx(C) && Oo.forEach(function(G) {
        return G(C);
  ...
  function ao(C) {
    ...
    if (!(C.type === "mousemove" && z)) {
      var Y = on().concat(v).map(function(G) {
        var Ie, Ye = G._tippy, mr = (Ie = Ye.popperInstance) == null ? void 0 : Ie.state;
        return mr ? {
  ...
  function lo() {
    co();
    var C = y.props, D = C.popperOptions, z = C.placement, Y = C.offset, G = C.getReferenceClientRect, Ie = C.moveTransition, Ye = U() ? Uu(v).arrow : null, mr = G ? {
    ...
    }), In.push.apply(In, (D == null ? void 0 : D.modifiers) || []), y.popperInstance = $x(mr, v, Object.assign({}, D, {
      placement: z,
      onFirstUpdate: f,
      modifiers: In
    }));
...
`, "See: https://atomiks.github.io/tippyjs/v6/accessibility/#interactivity"].join(" "));
  ...
  function rm() {
    ...
    var C = y.state.isVisible, D = y.state.isDestroyed, z = !y.state.isEnabled, Y = Ct.isTouch && !y.props.touch, G = Ja(y.props.duration, 0, Ge.duration);
    if (!(C || D || z || Y) && !K().hasAttribute("disabled") && (Me("onShow", [y], !1), y.props.onShow(y) !== !1)) {
      if (y.state.isVisible = !0, U() && (v.style.visibility = "visible"), pe(), ft(), y.state.isMounted || (v.style.transition = "none"), U()) {
        var Ie = ye(), Ye = Ie.box, mr = Ie.content;
        Za([Ye, mr], 0);
      }
      f = function() {
        var In;
  ...
  function im() {
    ...
    var C = !y.state.isVisible, D = y.state.isDestroyed, z = !y.state.isEnabled, Y = Ja(y.props.duration, 1, Ge.duration);
    if (!(C || D || z) && (Me("onHide", [y], !1), y.props.onHide(y) !== !1)) {
      if (y.state.isVisible = !1, y.state.isShown = !1, l = !1, s = !1, U() && (v.style.visibility = "hidden"), Dn(), Rt(), pe(!0), U()) {
        var G = ye(), Ie = G.box, Ye = G.content;
        y.props.animation && (Za([Ie, Ye], Y), vf([Ie, Ye], "hidden"));
      }
...
function Qr(t, e) {
  ...
  process.env.NODE_ENV !== "production" && (l5(t), t1(e, n)), i5();
...
class v5 {
  getTextContent(e) {
    return L0(e, { textSerializers: $l(this.editor.schema) });
  }
...
const C5 = X({
  ...
  setup(t) {
    ...
    return ur(() => {
      const r = t.editor;
      r && r.options.element && e.value && Cm(() => {
...
class S5 extends Pw {
  mount() {
    ...
    this.handleSelectionUpdate = this.handleSelectionUpdate.bind(this), this.editor.on("selectionUpdate", this.handleSelectionUpdate), this.renderer = new A5(r, {
      editor: this.editor,
      props: e
    });
  }
...
const T5 = /* @__PURE__ */ X({
  ...
  setup(t) {
    ...
    return (u, l) => {
      ...
      return xp((H(), $(S(x5), {
        ...
        default: N(() => [
          V(p, { class: "vuetify-pro-tiptap-editor__menu-bubble" }, {
            default: N(() => [
              V(f, { class: "d-flex pa-0" }, {
                default: N(() => [
                  V(d, {
                    density: "compact",
                    flat: "",
                    ...
                    default: N(() => [
                      (H(!0), ae(De, null, lt(s.value, (h, m) => {
                        var g;
                        return H(), ae(De, { key: m }, [
                          h.type === "divider" ? (H(), $(c, {
                            key: 0,
                            vertical: "",
                            class: "mx-1 me-2"
                            ...
                            lt(h.componentSlots, (b, x, w) => ({
                              name: `${x}`,
                              fn: N((y) => [
                                (H(), $(Vi(b), Er({ ref_for: !0 }, y == null ? void 0 : y.props), null, 16))
                              ])
                            }))
  ...
  setup(t) {
    ...
    return (i, o) => {
      ...
      return H(), $(u, Er(i.$attrs, {
        ...
        default: N(() => [
          (H(!0), ae(De, null, lt(r.value, (l, c) => {
            var d;
            return H(), ae(De, { key: c }, [
              l.spacer ? (H(), $(s, { key: 0 })) : it("", !0),
              (H(), $(Vi(l.button.component), Er({ ref_for: !0 }, l.button.componentProps, {
                editor: i.editor,
                ...
                lt(l.button.componentSlots, (f, p, h) => ({
                  name: `${p}`,
                  fn: N((m) => [
                    (H(), $(Vi(f), Er({ ref_for: !0 }, m == null ? void 0 : m.props), null, 16))
                  ])
                }))
              ]), 1040, ["editor", "disabled"])),
              l.divider ? (H(), $(a, {
...
}), E5 = { class: "text-overline me-4" }, O5 = { class: "text-overline" }, nM = /* @__PURE__ */ X({
  ...
  setup(t, { expose: e, emit: n }) {
    const r = t, i = n, o = Sm(), s = yl(), { state: a, isFullscreen: u } = Hy(), { markdownThemeStyle: l } = Gp(
      j(() => r.markdownTheme),
      (w) => {
        i("update:markdownTheme", w);
      }
    ), c = j(() => {
      const w = gy(r.extensions, a.extensions, "name");
    ...
    }, Mm), x = (w) => d == null ? void 0 : d.setEditable(!w);
    return Jt(() => r.modelValue, b), Jt(() => r.disabled, x), Tm(() => d == null ? void 0 : d.destroy()), e({ editor: d }), (w, y) => {
      const k = dm, v = Xi, E = Qi, M = Kr, O = Gr, B = fm, _ = gp;
      return S(d) ? (H(), ae("div", {
        key: 0,
                  ...
                  default: N(() => [
                    ...
                    Mt(w.$slots, "bottom", vc(wc({ editor: S(d) })), () => [
                      V(M, {
                        ...
                        default: N(() => [
                          V(E),
                          S(xy)(S(d), "characterCount") ? (H(), ae(De, { key: 0 }, [
                            Ze("span", E5, Le(S(d).storage.characterCount.words()) + " " + Le(S(f)("editor.words")), 1),
                            Ze("span", O5, Le(S(d).storage.characterCount.characters()) + " " + Le(S(f)("editor.characters")), 1)
                          ], 64)) : it("", !0)
                        ]),
                        _: 1
                      })
...
function D5(t) {
  var e;
  return t >= 55296 && t <= 57343 || t > 1114111 ? 65533 : (e = H5.get(t)) !== null && e !== void 0 ? e : t;
}
var Ce;
(function(t) {
...
class F5 {
  ...
  stateNumericStart(e, n) {
    return n >= e.length ? -1 : (e.charCodeAt(n) | _5) === Ce.LOWER_X ? (this.state = xe.NumericHex, this.consumed += 1, this.stateNumericHex(e, n + 1)) : (this.state = xe.NumericDecimal, this.stateNumericDecimal(e, n));
  }
  ...
  emitNumericEntity(e, n) {
    ...
    if (e === Ce.SEMI)
      ...
      return 0;
    return this.emitCodePoint(D5(this.result), this.consumed), this.errors && (e !== Ce.SEMI && this.errors.missingSemicolonAfterCharacterReference(), this.errors.validateNumericCharacterReference(this.result)), this.consumed;
  }
  /**
  ...
  stateNamedEntity(e, n) {
    ...
    for (; n < e.length; n++, this.excess++) {
      ...
      if (this.treeIndex = z5(r, i, this.treeIndex + Math.max(1, o), s), this.treeIndex < 0)
        return this.result === 0 || // If we are parsing an attribute
        this.decodeMode === hn.Attribute && // We shouldn't have consumed any characters after the entity,
        (o === 0 || // And there should be no invalid characters.
        B5(s)) ? 0 : this.emitNotTerminatedNamedEntity();
...
const Mf = /^[^\\#]?(?:\\(?:[\da-f]{1,6}\s?|.)|[\w\-\u00b0-\uFFFF])+/, W5 = /\\([\da-f]{1,6}\s?|(\s)|.)/gi, q5 = /* @__PURE__ */ new Map([
  [126, rt.Element],
  [94, rt.Start],
  [36, rt.End],
  [42, rt.Any],
...
const G5 = /* @__PURE__ */ new Set(["contains", "icontains"]);
function J5(t, e, n) {
  ...
  e: for (; n < e.length; ) {
    ...
    switch (f) {
      ...
      case 91: {
        ...
        let m = rt.Exists;
        const g = q5.get(e.charCodeAt(n));
        if (g) {
          if (m = g, e.charCodeAt(n + 1) !== 61)
            throw new Error("Expected `=`");
          o(2);
        } else e.charCodeAt(n) === 61 && (m = rt.Equals, o(1));
        let b = "", x = null;
        if (m !== "exists") {
...
function Q5(t) {
  let e = Nf[t];
  return e == null && (e = Z5(t), Nf[t] = e), e;
}
function ek(t, e, { debug: n = !1 } = {}) {
  for (const r of Q5(t)) {
    const i = (o, s) => {
      var u, l, c, d;
      let a = !1;
...
var tk = Symbol.for("nodejs.util.inspect.custom"), Lf = { fontWeight: "bold" }, Vf = { fontStyle: "italic" }, Hf = { backgroundColor: "rgb(255, 250, 165)" }, Rf = { textDecorations: "underline" }, tu = { textDecorations: "line-through" }, nk = {
  b: Lf,
  strong: Lf,
  em: Vf,
  i: Vf,
...
wa.html = !0;
var ak = /([^=\s]+)(\s*=\s*(("([^"]*)")|('([^']*)')|[^>\s]+))?/g, uk = /^<\/([^>\s]+)[^>]*>/m, lk = /^<([^>\s/]+)((\s+[^=>\s]+(\s*=\s*(("[^"]*")|('[^']*')|[^>\s]+))?)*)\s*(?:\/\s*)?>/m, ck = /\s*\/\s*>\s*$/m, dk = class {
  constructor(t = {}) {
    this.attrRe = ak, this.endTagRe = uk, this.startTagRe = lk, this.defaults = { ignoreWhitespaceText: !1 }, t.scanner && (this.scanner = t.scanner), this.options = Object.assign({}, this.defaults, t);
  }
  parse(t) {
    let e = !1, n, r, i;
    for (; t.length; ) {
...
function hk(t, e) {
  const n = tw(e), r = Kt.fromJSON(n, t);
  return pk(r, n);
}
function mk(t) {
...
function v1(t) {
  t = Ak(t || {}), t.whiteList = t.whiteList || No.whiteList, t.onAttr = t.onAttr || No.onAttr, t.onIgnoreAttr = t.onIgnoreAttr || No.onIgnoreAttr, t.safeAttrValue = t.safeAttrValue || No.safeAttrValue, this.options = t;
}
v1.prototype.process = function(t) {
  if (t = t || "", t = t.toString(), !t) return "";
  var e = this, n = e.options, r = n.whiteList, i = n.onAttr, o = n.onIgnoreAttr, s = n.safeAttrValue, a = Ck(t, function(u, l, c, d, f) {
    var p = r[c], h = !1;
...
}, Tk = nc.FilterCSS, Mk = nc.getDefaultWhiteList, vs = rc;
function w1() {
  return {
    a: ["target", "href", "title"],
    abbr: ["title"],
...
function k1(t) {
  return t.replace(Hk, "&lt;").replace(Rk, "&gt;");
}
function Vk(t, e, n, r) {
...
var Hk = /</g, Rk = />/g, Dk = /"/g, _k = /&quot;/g, Pk = /&#([a-zA-Z0-9]*);?/gim, Ik = /&colon;?/gim, Bk = /&newline;?/gim, Lo = /((j\s*a\s*v\s*a|v\s*b|l\s*i\s*v\s*e)\s*s\s*c\s*r\s*i\s*p\s*t\s*|m\s*o\s*c\s*h\s*a):/gi, Pf = /e\s*x\s*p\s*r\s*e\s*s\s*s\s*i\s*o\s*n\s*\(.*/gi, If = /u\s*r\s*l\s*\(.*/gi;
function C1(t) {
  return t.replace(Dk, "&quot;");
}
function A1(t) {
...
ue.onIgnoreTagStripAll = Fk;
ue.StripTagBody = zk;
ue.stripCommentTag = $k;
ue.stripBlankChar = jk;
ue.attributeWrapSign = '"';
ue.cssFilter = x1;
ue.getDefaultCSSWhiteList = Mk;
var xa = {}, cn = rc;
function Wk(t) {
...
function Uk(t, e, n) {
  ...
  e: for (a = 0; a < u; a++) {
    ...
    if (o === !1) {
      ...
      if (d === ">" || a === u - 1) {
        r += n(t.slice(i, o)), c = t.slice(o, a + 1), l = Wk(c), r += e(
          o,
          r.length,
          l,
          c,
...
var Kk = /[^a-zA-Z0-9\\_:.-]/gim;
function Gk(t, e) {
  var n = 0, r = 0, i = [], o = !1, s = t.length;
  function a(f, p) {
    if (f = cn.trim(f), f = f.replace(Kk, "").toLowerCase(), !(f.length < 1)) {
      var h = e(f, p || "");
      h && i.push(h);
    }
  }
  for (var u = 0; u < s; u++) {
    ...
    if (o === !1 && l === "=") {
      o = t.slice(n, u), n = u + 1, r = t.charAt(n) === '"' || t.charAt(n) === "'" ? n : Zk(t, u + 1);
      continue;
    }
    if (o !== !1 && u === r) {
...
function Bf(t) {
  return Yk(t) ? t.substr(1, t.length - 2) : t;
}
xa.parseTag = Uk;
xa.parseAttr = Gk;
var Qk = nc.FilterCSS, tt = ue, N1 = xa, e8 = N1.parseTag, t8 = N1.parseAttr, Go = rc;
function Vo(t) {
  return t == null;
}
function n8(t) {
...
function L1(t) {
  t = r8(t || {}), t.stripIgnoreTag && (t.onIgnoreTag && console.error(
    'Notes: cannot use these two options "stripIgnoreTag" and "onIgnoreTag" at the same time'
  ), t.onIgnoreTag = tt.onIgnoreTagStripAll), t.whiteList || t.allowList ? t.whiteList = i8(t.whiteList || t.allowList) : t.whiteList = tt.whiteList, this.attributeWrapSign = t.singleQuotedAttributeValue === !0 ? "'" : tt.attributeWrapSign, t.onTag = t.onTag || tt.onTag, t.onTagAttr = t.onTagAttr || tt.onTagAttr, t.onIgnoreTag = t.onIgnoreTag || tt.onIgnoreTag, t.onIgnoreTagAttr = t.onIgnoreTagAttr || tt.onIgnoreTagAttr, t.safeAttrValue = t.safeAttrValue || tt.safeAttrValue, t.escapeHtml = t.escapeHtml || tt.escapeHtml, this.options = t, t.css === !1 ? this.cssFilter = !1 : (t.css = t.css || {}, this.cssFilter = new Qk(t.css));
}
L1.prototype.process = function(t) {
  if (t = t || "", t = t.toString(), !t) return "";
  ...
  n.stripBlankChar && (t = tt.stripBlankChar(t)), n.allowCommentTag || (t = tt.stripCommentTag(t));
  var f = !1;
  n.stripIgnoreTagBody && (f = tt.StripTagBody(
  ...
  var p = e8(
    ...
    function(h, m, g, b, x) {
      ...
      if (w.isWhite) {
        if (w.isClosing)
          return "</" + g + ">";
        var k = n8(b), v = r[g], E = t8(k.html, function(M, O) {
...
var s8 = Ju.exports;
const a8 = /* @__PURE__ */ mk(s8), u8 = ["innerHTML"], rM = /* @__PURE__ */ X({
  ...
  setup(t) {
    const e = t, { state: n } = Xs(), r = yl(), { markdownThemeStyle: i } = Gp(j(() => e.markdownTheme)), o = j(() => [...n.extensions, ...e.extensions]), s = j(() => _r(e.dark) ? e.dark : _r(r.current.value.dark) ? r.current.value.dark : !1), a = j(() => ({
      ...
      view: !0,
      ...S(i)
    })), u = j(() => yi(e.value) ? e.value : hk(e.value, S(o))), l = j(() => {
      if (e.xss === !1)
        return S(u);
...
function b8() {
  return new se({
    props: {
      ...
      handleClick: v8,
      handleKeyDown: y8,
      handleDOMEvents: { beforeinput: w8 }
    }
  });
}
const y8 = Pl({
...
`;
  ...
  parseHTML() {
    return [
      {
        tag: "span",
        getAttrs: (t) => t.hasAttribute("style") ? (this.options.mergeNestedSpanStyles && E8(t), {}) : !1
      }
    ];
  },
  renderHTML({ HTMLAttributes: t }) {
...
var N8 = "M19,12H17V15H14V17H19V12M7,9H10V7H5V12H7V9M21,3H3A2,2 0 0,0 1,5V19A2,2 0 0,0 3,21H21A2,2 0 0,0 23,19V5A2,2 0 0,0 21,3M21,19H3V5H21V19Z", L8 = "M21,7L9,19L3.5,13.5L4.91,12.09L9,16.17L19.59,5.59L21,7Z", V8 = "M12,2A10,10 0 0,0 2,12A10,10 0 0,0 12,22A10,10 0 0,0 22,12A10,10 0 0,0 12,2Z", H8 = "M19,6.41L17.59,5L12,10.59L6.41,5L5,6.41L10.59,12L5,17.59L6.41,19L12,13.41L17.59,19L19,17.59L13.41,12L19,6.41Z", R8 = "M19 3H5C3.9 3 3 3.9 3 5V19C3 20.1 3.9 21 5 21H19C20.1 21 21 20.1 21 19V5C21 3.9 20.1 3 19 3M11 8H9V10C9 11.1 8.1 12 7 12C8.1 12 9 12.9 9 14V16H11V18H9C7.9 18 7 17.1 7 16V15C7 13.9 6.1 13 5 13V11C6.1 11 7 10.1 7 9V8C7 6.9 7.9 6 9 6H11V8M19 13C17.9 13 17 13.9 17 15V16C17 17.1 16.1 18 15 18H13V16H15V14C15 12.9 15.9 12 17 12C15.9 12 15 11.1 15 10V8H13V6H15C16.1 6 17 6.9 17 8V9C17 10.1 17.9 11 19 11V13Z", D8 = "M14.6,16.6L19.2,12L14.6,7.4L16,6L22,12L16,18L14.6,16.6M9.4,16.6L4.8,12L9.4,7.4L8,6L2,12L8,18L9.4,16.6Z", _8 = "M19,4H15.5L14.5,3H9.5L8.5,4H5V6H19M6,19A2,2 0 0,0 8,21H16A2,2 0 0,0 18,19V7H6V19Z", P8 = "M13.09 20H6L12 14L13.88 15.88C14.5 14.9 15.36 14.1 16.4 13.6L18 12V13.09C18.33 13.04 18.66 13 19 13C19.34 13 19.67 13.04 20 13.09V8L14 2H6C4.89 2 4 2.89 4 4V20C4 21.1 4.89 22 6 22H13.81C13.46 21.39 13.21 20.72 13.09 20M13 3.5L18.5 9H13V3.5M8 9C9.11 9 10 9.9 10 11S9.11 13 8 13 6 12.11 6 11 6.9 9 8 9M20 15V18H23V20H20V23H18V20H15V18H18V15H20Z", Ff = "M3,3H21V5H3V3M7,7H17V9H7V7M3,11H21V13H3V11M7,15H17V17H7V15M3,19H21V21H3V19Z", I8 = "M3,3H21V5H3V3M3,7H21V9H3V7M3,11H21V13H3V11M3,15H21V17H3V15M3,19H21V21H3V19Z", B8 = "M3,3H21V5H3V3M3,7H15V9H3V7M3,11H21V13H3V11M3,15H15V17H3V15M3,19H21V21H3V19Z", F8 = "M3,3H21V5H3V3M9,7H21V9H9V7M3,11H21V13H3V11M9,15H21V17H9V15M3,19H21V21H3V19Z", z8 = "M13.5,15.5H10V12.5H13.5A1.5,1.5 0 0,1 15,14A1.5,1.5 0 0,1 13.5,15.5M10,6.5H13A1.5,1.5 0 0,1 14.5,8A1.5,1.5 0 0,1 13,9.5H10M15.6,10.79C16.57,10.11 17.25,9 17.25,8C17.25,5.74 15.5,4 13.25,4H7V18H14.04C16.14,18 17.75,16.3 17.75,14.21C17.75,12.69 16.89,11.39 15.6,10.79Z", $8 = "M6,5V5.18L8.82,8H11.22L10.5,9.68L12.6,11.78L14.21,8H20V5H6M3.27,5L2,6.27L8.97,13.24L6.5,19H9.5L11.07,15.34L16.73,21L18,19.73L3.55,5.27L3.27,5Z", j8 = "M4,17L6.75,14.25L6.72,14.23C6.14,13.64 6.14,12.69 6.72,12.11L11.46,7.37L15.7,11.61L10.96,16.35C10.39,16.93 9.46,16.93 8.87,16.37L8.24,17H4M15.91,2.91C16.5,2.33 17.45,2.33 18.03,2.91L20.16,5.03C20.74,5.62 20.74,6.57 20.16,7.16L16.86,10.45L12.62,6.21L15.91,2.91Z", W8 = "M3,7H9V13H3V7M3,3H21V5H3V3M21,7V9H11V7H21M21,11V13H11V11H21M3,15H17V17H3V15M3,19H21V21H3V19Z", q8 = "M3,7H9V13H3V7M3,3H21V5H3V3M21,11V13H11V11H21M3,15H17V17H3V15M3,19H21V21H3V19Z", U8 = "M15,7H21V13H15V7M3,3H21V5H3V3M13,7V9H3V7H13M9,11V13H3V11H9M3,15H17V17H3V15M3,19H21V21H3V19Z", K8 = "M17,8H20V20H21V21H17V20H18V17H14L12.5,20H14V21H10V20H11L17,8M18,9L14.5,16H18V9M5,3H10C11.11,3 12,3.89 12,5V16H9V11H6V16H3V5C3,3.89 3.89,3 5,3M6,5V9H9V5H6Z", G8 = "M3,4H5V10H9V4H11V18H9V12H5V18H3V4M14,18V16H16V6.31L13.5,7.75V5.44L16,4H18V16H20V18H14Z", J8 = "M3,4H5V10H9V4H11V18H9V12H5V18H3V4M21,18H15A2,2 0 0,1 13,16C13,15.47 13.2,15 13.54,14.64L18.41,9.41C18.78,9.05 19,8.55 19,8A2,2 0 0,0 17,6A2,2 0 0,0 15,8H13A4,4 0 0,1 17,4A4,4 0 0,1 21,8C21,9.1 20.55,10.1 19.83,10.83L15,16H21V18Z", Z8 = "M3,4H5V10H9V4H11V18H9V12H5V18H3V4M15,4H19A2,2 0 0,1 21,6V16A2,2 0 0,1 19,18H15A2,2 0 0,1 13,16V15H15V16H19V12H15V10H19V6H15V7H13V6A2,2 0 0,1 15,4Z", X8 = "M3,4H5V10H9V4H11V18H9V12H5V18H3V4M18,18V13H13V11L18,4H20V11H21V13H20V18H18M18,11V7.42L15.45,11H18Z", Y8 = "M3,4H5V10H9V4H11V18H9V12H5V18H3V4M15,4H20V6H15V10H17A4,4 0 0,1 21,14A4,4 0 0,1 17,18H15A2,2 0 0,1 13,16V15H15V16H17A2,2 0 0,0 19,14A2,2 0 0,0 17,12H15A2,2 0 0,1 13,10V6A2,2 0 0,1 15,4Z", Q8 = "M3,4H5V10H9V4H11V18H9V12H5V18H3V4M15,4H19A2,2 0 0,1 21,6V7H19V6H15V10H19A2,2 0 0,1 21,12V16A2,2 0 0,1 19,18H15A2,2 0 0,1 13,16V6A2,2 0 0,1 15,4M15,12V16H19V12H15Z", eC = "M3,4H5V10H9V4H11V18H9V12H5V18H3V4M13,8H15.31L15.63,5H17.63L17.31,8H19.31L19.63,5H21.63L21.31,8H23V10H21.1L20.9,12H23V14H20.69L20.37,17H18.37L18.69,14H16.69L16.37,17H14.37L14.69,14H13V12H14.9L15.1,10H13V8M17.1,10L16.9,12H18.9L19.1,10H17.1Z", tC = "M11,13H21V11H11M11,9H21V7H11M3,3V5H21V3M3,21H21V19H3M3,12L7,16V8M11,17H21V15H11V17Z", nC = "M11,13H21V11H11M11,9H21V7H11M3,3V5H21V3M11,17H21V15H11M3,8V16L7,12M3,21H21V19H3V21Z", rC = "M10,4V7H12.21L8.79,15H6V18H14V15H11.79L15.21,7H18V4H10Z", iC = "M7,5H21V7H7V5M7,13V11H21V13H7M4,4.5A1.5,1.5 0 0,1 5.5,6A1.5,1.5 0 0,1 4,7.5A1.5,1.5 0 0,1 2.5,6A1.5,1.5 0 0,1 4,4.5M4,10.5A1.5,1.5 0 0,1 5.5,12A1.5,1.5 0 0,1 4,13.5A1.5,1.5 0 0,1 2.5,12A1.5,1.5 0 0,1 4,10.5M7,19V17H21V19H7M4,16.5A1.5,1.5 0 0,1 5.5,18A1.5,1.5 0 0,1 4,19.5A1.5,1.5 0 0,1 2.5,18A1.5,1.5 0 0,1 4,16.5Z", oC = "M21,19V17H8V19H21M21,13V11H8V13H21M8,7H21V5H8V7M4,5V7H6V5H4M3,5A1,1 0 0,1 4,4H6A1,1 0 0,1 7,5V7A1,1 0 0,1 6,8H4A1,1 0 0,1 3,7V5M4,11V13H6V11H4M3,11A1,1 0 0,1 4,10H6A1,1 0 0,1 7,11V13A1,1 0 0,1 6,14H4A1,1 0 0,1 3,13V11M4,17V19H6V17H4M3,17A1,1 0 0,1 4,16H6A1,1 0 0,1 7,17V19A1,1 0 0,1 6,20H4A1,1 0 0,1 3,19V17Z", sC = "M7,13V11H21V13H7M7,19V17H21V19H7M7,7V5H21V7H7M3,8V5H2V4H4V8H3M2,17V16H5V20H2V19H4V18.5H3V17.5H4V17H2M4.25,10A0.75,0.75 0 0,1 5,10.75C5,10.95 4.92,11.14 4.79,11.27L3.12,13H5V14H2V13.08L4,11H2V10H4.25Z", aC = "M13,4A4,4 0 0,1 17,8A4,4 0 0,1 13,12H11V18H9V4H13M13,10A2,2 0 0,0 15,8A2,2 0 0,0 13,6H11V10H13Z", uC = "M10,7L8,11H11V17H5V11L7,7H10M18,7L16,11H19V17H13V11L15,7H18Z", lC = "M2 4V7H7V19H10V7H15V4H2M21 9H12V12H15V19H18V12H21V9Z", cC = "M3,14H21V12H3M5,4V7H10V10H14V7H19V4M10,19H14V16H10V19Z", dC = "M16,7.41L11.41,12L16,16.59L14.59,18L10,13.41L5.41,18L4,16.59L8.59,12L4,7.41L5.41,6L10,10.59L14.59,6L16,7.41M21.85,21.03H16.97V20.03L17.86,19.23C18.62,18.58 19.18,18.04 19.56,17.6C19.93,17.16 20.12,16.75 20.13,16.36C20.14,16.08 20.05,15.85 19.86,15.66C19.68,15.5 19.39,15.38 19,15.38C18.69,15.38 18.42,15.44 18.16,15.56L17.5,15.94L17.05,14.77C17.32,14.56 17.64,14.38 18.03,14.24C18.42,14.1 18.85,14 19.32,14C20.1,14.04 20.7,14.25 21.1,14.66C21.5,15.07 21.72,15.59 21.72,16.23C21.71,16.79 21.53,17.31 21.18,17.78C20.84,18.25 20.42,18.7 19.91,19.14L19.27,19.66V19.68H21.85V21.03Z", fC = "M16,7.41L11.41,12L16,16.59L14.59,18L10,13.41L5.41,18L4,16.59L8.59,12L4,7.41L5.41,6L10,10.59L14.59,6L16,7.41M21.85,9H16.97V8L17.86,7.18C18.62,6.54 19.18,6 19.56,5.55C19.93,5.11 20.12,4.7 20.13,4.32C20.14,4.04 20.05,3.8 19.86,3.62C19.68,3.43 19.39,3.34 19,3.33C18.69,3.34 18.42,3.4 18.16,3.5L17.5,3.89L17.05,2.72C17.32,2.5 17.64,2.33 18.03,2.19C18.42,2.05 18.85,2 19.32,2C20.1,2 20.7,2.2 21.1,2.61C21.5,3 21.72,3.54 21.72,4.18C21.71,4.74 21.53,5.26 21.18,5.73C20.84,6.21 20.42,6.66 19.91,7.09L19.27,7.61V7.63H21.85V9Z", pC = "M5,21H19V19H5V21M12,17A6,6 0 0,0 18,11V3H15.5V11A3.5,3.5 0 0,1 12,14.5A3.5,3.5 0 0,1 8.5,11V3H6V11A6,6 0 0,0 12,17Z", hC = "M5,5H10V7H7V10H5V5M14,5H19V10H17V7H14V5M17,14H19V19H14V17H17V14M10,17V19H5V14H7V17H10Z", mC = "M14,14H19V16H16V19H14V14M5,14H10V19H8V16H5V14M8,5H10V10H5V8H8V5M19,8V10H14V5H16V8H19Z", gC = "M18 15V18H15V20H18V23H20V20H23V18H20V15H18M13.3 21H5C3.9 21 3 20.1 3 19V5C3 3.9 3.9 3 5 3H19C20.1 3 21 3.9 21 5V13.3C20.4 13.1 19.7 13 19 13C17.9 13 16.8 13.3 15.9 13.9L14.5 12L11 16.5L8.5 13.5L5 18H13.1C13 18.3 13 18.7 13 19C13 19.7 13.1 20.4 13.3 21Z", bC = "M2,5.27L3.28,4L20,20.72L18.73,22L13.9,17.17L11.29,19.78C9.34,21.73 6.17,21.73 4.22,19.78C2.27,17.83 2.27,14.66 4.22,12.71L5.71,11.22C5.7,12.04 5.83,12.86 6.11,13.65L5.64,14.12C4.46,15.29 4.46,17.19 5.64,18.36C6.81,19.54 8.71,19.54 9.88,18.36L12.5,15.76L10.88,14.15C10.87,14.39 10.77,14.64 10.59,14.83C10.2,15.22 9.56,15.22 9.17,14.83C8.12,13.77 7.63,12.37 7.72,11L2,5.27M12.71,4.22C14.66,2.27 17.83,2.27 19.78,4.22C21.73,6.17 21.73,9.34 19.78,11.29L18.29,12.78C18.3,11.96 18.17,11.14 17.89,10.36L18.36,9.88C19.54,8.71 19.54,6.81 18.36,5.64C17.19,4.46 15.29,4.46 14.12,5.64L10.79,8.97L9.38,7.55L12.71,4.22M13.41,9.17C13.8,8.78 14.44,8.78 14.83,9.17C16.2,10.54 16.61,12.5 16.06,14.23L14.28,12.46C14.23,11.78 13.94,11.11 13.41,10.59C13,10.2 13,9.56 13.41,9.17Z", zf = "M10.6 13.4A1 1 0 0 1 9.2 14.8A4.8 4.8 0 0 1 9.2 7.8L12.7 4.2A5.1 5.1 0 0 1 19.8 4.2A5.1 5.1 0 0 1 19.8 11.3L18.3 12.8A6.4 6.4 0 0 0 17.9 10.4L18.4 9.9A3.2 3.2 0 0 0 18.4 5.6A3.2 3.2 0 0 0 14.1 5.6L10.6 9.2A2.9 2.9 0 0 0 10.6 13.4M23 18V20H20V23H18V20H15V18H18V15H20V18M16.2 13.7A4.8 4.8 0 0 0 14.8 9.2A1 1 0 0 0 13.4 10.6A2.9 2.9 0 0 1 13.4 14.8L9.9 18.4A3.2 3.2 0 0 1 5.6 18.4A3.2 3.2 0 0 1 5.6 14.1L6.1 13.7A7.3 7.3 0 0 1 5.7 11.2L4.2 12.7A5.1 5.1 0 0 0 4.2 19.8A5.1 5.1 0 0 0 11.3 19.8L13.1 18A6 6 0 0 1 16.2 13.7Z", yC = "M19,13H5V11H19V13Z", vC = "M14,3V5H17.59L7.76,14.83L9.17,16.24L19,6.41V10H21V3M19,19H5V5H12V3H5C3.89,3 3,3.9 3,5V19A2,2 0 0,0 5,21H19A2,2 0 0,0 21,19V12H19V19Z", wC = "M17.5,12A1.5,1.5 0 0,1 16,10.5A1.5,1.5 0 0,1 17.5,9A1.5,1.5 0 0,1 19,10.5A1.5,1.5 0 0,1 17.5,12M14.5,8A1.5,1.5 0 0,1 13,6.5A1.5,1.5 0 0,1 14.5,5A1.5,1.5 0 0,1 16,6.5A1.5,1.5 0 0,1 14.5,8M9.5,8A1.5,1.5 0 0,1 8,6.5A1.5,1.5 0 0,1 9.5,5A1.5,1.5 0 0,1 11,6.5A1.5,1.5 0 0,1 9.5,8M6.5,12A1.5,1.5 0 0,1 5,10.5A1.5,1.5 0 0,1 6.5,9A1.5,1.5 0 0,1 8,10.5A1.5,1.5 0 0,1 6.5,12M12,3A9,9 0 0,0 3,12A9,9 0 0,0 12,21A1.5,1.5 0 0,0 13.5,19.5C13.5,19.11 13.35,18.76 13.11,18.5C12.88,18.23 12.73,17.88 12.73,17.5A1.5,1.5 0 0,1 14.23,16H16A5,5 0 0,0 21,11C21,6.58 16.97,3 12,3Z", xC = "M18.4,10.6C16.55,9 14.15,8 11.5,8C6.85,8 2.92,11.03 1.54,15.22L3.9,16C4.95,12.81 7.95,10.5 11.5,10.5C13.45,10.5 15.23,11.22 16.62,12.38L13,16H22V7L18.4,10.6Z", kC = "M9 7V17H15V15H11V7H9Z", CC = "M9 7C7.9 7 7 7.9 7 9V17H9V9H11V16H13V9H15V17H17V9C17 7.9 16.11 7 15 7H9Z", AC = "M11 7C9.9 7 9 7.9 9 9V11C9 12.11 9.9 13 11 13H13V15H9V17H13C14.11 17 15 16.11 15 15V13C15 11.9 14.11 11 13 11H11V9H15V7H11Z", SC = "M5,4H19A2,2 0 0,1 21,6V18A2,2 0 0,1 19,20H5A2,2 0 0,1 3,18V6A2,2 0 0,1 5,4M5,8V12H11V8H5M13,8V12H19V8H13M5,14V18H11V14H5M13,14V18H19V14H13Z", TC = "M11,2A2,2 0 0,1 13,4V20A2,2 0 0,1 11,22H2V2H11M4,10V14H11V10H4M4,16V20H11V16H4M4,4V8H11V4H4M15,11H18V8H20V11H23V13H20V16H18V13H15V11Z", MC = "M13,2A2,2 0 0,0 11,4V20A2,2 0 0,0 13,22H22V2H13M20,10V14H13V10H20M20,16V20H13V16H20M20,4V8H13V4H20M9,11H6V8H4V11H1V13H4V16H6V13H9V11Z", EC = "M4,2H11A2,2 0 0,1 13,4V20A2,2 0 0,1 11,22H4A2,2 0 0,1 2,20V4A2,2 0 0,1 4,2M4,10V14H11V10H4M4,16V20H11V16H4M4,4V8H11V4H4M17.59,12L15,9.41L16.41,8L19,10.59L21.59,8L23,9.41L20.41,12L23,14.59L21.59,16L19,13.41L16.41,16L15,14.59L17.59,12Z", OC = "M5,10H3V4H11V6H5V10M19,18H13V20H21V14H19V18M5,18V14H3V20H11V18H5M21,4H13V6H19V10H21V4M8,13V15L11,12L8,9V11H3V13H8M16,11V9L13,12L16,15V13H21V11H16Z", NC = "M18,14H20V17H23V19H20V22H18V19H15V17H18V14M4,3H18A2,2 0 0,1 20,5V12.08C18.45,11.82 16.92,12.18 15.68,13H12V17H13.08C12.97,17.68 12.97,18.35 13.08,19H4A2,2 0 0,1 2,17V5A2,2 0 0,1 4,3M4,7V11H10V7H4M12,7V11H18V7H12M4,13V17H10V13H4Z", LC = "M15.46,15.88L16.88,14.46L19,16.59L21.12,14.46L22.54,15.88L20.41,18L22.54,20.12L21.12,21.54L19,19.41L16.88,21.54L15.46,20.12L17.59,18L15.46,15.88M4,3H18A2,2 0 0,1 20,5V12.08C18.45,11.82 16.92,12.18 15.68,13H12V17H13.08C12.97,17.68 12.97,18.35 13.08,19H4A2,2 0 0,1 2,17V5A2,2 0 0,1 4,3M4,7V11H10V7H4M12,7V11H18V7H12M4,13V17H10V13H4Z", VC = "M22,10A2,2 0 0,1 20,12H4A2,2 0 0,1 2,10V3H4V5H8V3H10V5H14V3H16V5H20V3H22V10M4,10H8V7H4V10M10,10H14V7H10V10M20,10V7H16V10H20M11,14H13V17H16V19H13V22H11V19H8V17H11V14Z", HC = "M22,14A2,2 0 0,0 20,12H4A2,2 0 0,0 2,14V21H4V19H8V21H10V19H14V21H16V19H20V21H22V14M4,14H8V17H4V14M10,14H14V17H10V14M20,14V17H16V14H20M11,10H13V7H16V5H13V2H11V5H8V7H11V10Z", RC = "M9.41,13L12,15.59L14.59,13L16,14.41L13.41,17L16,19.59L14.59,21L12,18.41L9.41,21L8,19.59L10.59,17L8,14.41L9.41,13M22,9A2,2 0 0,1 20,11H4A2,2 0 0,1 2,9V6A2,2 0 0,1 4,4H20A2,2 0 0,1 22,6V9M4,9H8V6H4V9M10,9H14V6H10V9M16,9H20V6H16V9Z", DC = "M21,6V8H3V6H21M3,18H12V16H3V18M3,13H21V11H3V13Z", _C = "M12.5,8C9.85,8 7.45,9 5.6,10.6L2,7V16H11L7.38,12.38C8.77,11.22 10.54,10.5 12.5,10.5C16.04,10.5 19.05,12.81 20.1,16L22.47,15.22C21.08,11.03 17.15,8 12.5,8Z", PC = "M17,10.5V7A1,1 0 0,0 16,6H4A1,1 0 0,0 3,7V17A1,1 0 0,0 4,18H16A1,1 0 0,0 17,17V13.5L21,17.5V6.5L17,10.5M14,13H11V16H9V13H6V11H9V8H11V11H14V13Z", IC = "M12,20A6,6 0 0,1 6,14C6,10 12,3.25 12,3.25C12,3.25 18,10 18,14A6,6 0 0,1 12,20Z";
const BC = {
  bold: z8,
  italic: rC,
  underline: pC,
  ...
  tablePlus: NC,
  tableRemove: LC,
  tableColumnPlusAfter: TC,
  tableColumnPlusBefore: MC,
  tableColumnRemove: EC,
  tableRowPlusAfter: VC,
  tableRowPlusBefore: HC,
  tableRowRemove: RC,
  tableMergeCells: OC,
  check: L8
};
...
const Z = /* @__PURE__ */ X({
...
], WC = (t, e, { editor: n, extension: r, t: i }) => {
  ...
  addExtensions() {
    ...
    ), this.options.document !== !1 && t.push(c8.configure()), this.options.text !== !1 && t.push(M8.configure()), this.options.gapcursor !== !1 && t.push(k8.configure()), this.options.dropcursor !== !1 && t.push(p8.configure(this.options.dropcursor)), this.options.characterCount !== !1 && t.push(l8.configure(this.options.characterCount)), this.options.paragraph !== !1 && t.push(S8.configure(this.options.paragraph)), this.options.hardBreak !== !1 && t.push(C8.configure(this.options.hardBreak)), this.options.listItem !== !1 && t.push(A8.configure(this.options.listItem)), this.options.textStyle !== !1 && t.push(O8.configure(this.options.textStyle)), t;
  }
}), qC = /^\s*>\s$/, UC = /* @__PURE__ */ fe.create({
  name: "blockquote",
  addOptions() {
    return {
      HTMLAttributes: {}
...
}), KC = /(?:^|\s)(\*\*(?!\s+\*\*)((?:[^*]+))\*\*(?!\s+\*\*))$/, GC = /(?:^|\s)(\*\*(?!\s+\*\*)((?:[^*]+))\*\*(?!\s+\*\*))/g, JC = /(?:^|\s)(__(?!\s+__)((?:[^_]+))__(?!\s+__))$/, ZC = /(?:^|\s)(__(?!\s+__)((?:[^_]+))__(?!\s+__))/g, XC = /* @__PURE__ */ Ue.create({
  name: "bold",
  addOptions() {
    return {
      HTMLAttributes: {}
...
}), YC = "listItem", $f = "textStyle", jf = /^\s*([-+*])\s$/, QC = /* @__PURE__ */ fe.create({
  name: "bulletList",
  addOptions() {
    return {
  ...
  addCommands() {
    return {
      toggleBulletList: () => ({ commands: t, chain: e }) => this.options.keepAttributes ? e().toggleList(this.name, this.options.itemTypeName, this.options.keepMarks).updateAttributes(YC, this.editor.getAttributes($f)).run() : t.toggleList(this.name, this.options.itemTypeName, this.options.keepMarks)
    };
  },
  addKeyboardShortcuts() {
    return {
...
`));
  ...
  setup(t, { emit: e }) {
    ...
    return (a, u) => {
      const l = On, c = Jr, d = dl, f = pm, p = fl, h = Ks;
      return H(), $(h, {
        modelValue: o.value,
          ...
          V(d, {
            ...
            default: N(() => [
              V(c, {
                ...
                default: N(() => [
                  (H(!0), ae(De, null, lt(i.items, (f, p) => (H(), ae(De, { key: p }, [
                    V(u, {
                      active: f.isActive(),
                      disabled: f.disabled,
                      onClick: f.action
...
}), dA = /(?:^|\s)(==(?!\s+==)((?:[^=]+))==(?!\s+==))$/, fA = /(?:^|\s)(==(?!\s+==)((?:[^=]+))==(?!\s+==))/g, pA = /* @__PURE__ */ Ue.create({
  name: "highlight",
  addOptions() {
    return {
      multicolor: !1,
...
Se.from = function(e) {
  return e instanceof Se ? e : e && e.length ? new H1(e) : Se.empty;
};
...
class ht {
  ...
  addTransform(e, n, r, i) {
    ...
    let l = s - r.depth;
    return l > yA && (a = bA(a, l), s -= l), new ht(a.append(o), s);
  }
  remapping(e, n) {
    let r = new Lr();
  ...
  rebased(e, n) {
    ...
    return d.emptyItemCount() > gA && (d = d.compress(this.items.length - r.length)), d;
  }
  emptyItemCount() {
    let e = 0;
...
function vA(t, e, n, r) {
  ...
  n.getMeta(kA) && (t = new dn(t.done, t.undone, null, 0, -1));
  ...
  if (n.getMeta("addToHistory") !== !1 && !(s && s.getMeta("addToHistory") === !1)) {
    let a = n.getMeta("composition"), u = t.prevTime == 0 || !s && t.prevComposition != a && (t.prevTime < (n.time || 0) - r.newGroupDelay || !wA(n, t.prevRanges)), l = s ? nu(t.prevRanges, n.mapping) : Wf(n.mapping.maps);
...
const Yn = new be("history"), kA = new be("closeHistory");
function CA(t = {}) {
  return t = {
    depth: t.depth || 100,
...
const D1 = R1(!1, !0), _1 = R1(!0, !0), AA = /* @__PURE__ */ ne.create({
  name: "history",
  addOptions() {
    return {
      depth: 100,
...
}), TA = /(?:^|\s)(!\[(.+|:?)]\((\S+)(?:(?:\s+)["'](\S+)["'])?\))$/, MA = /* @__PURE__ */ fe.create({
  name: "image",
  addOptions() {
    return {
      inline: !1,
  ...
  setup(t, { emit: e }) {
    ...
    return (a, u) => {
      const l = hm, c = dl, d = Gs, f = Js;
      return H(), $(f, { disabled: i.value }, {
        default: N(() => [
          V(l, {
...
}), NA = { class: "headline" }, LA = /* @__PURE__ */ X({
  __name: "ImageDialog",
  props: {
    value: { default: () => ({}) },
    editor: {},
  ...
  setup(t) {
    ...
    return Jt(
      ...
      const f = Qi, p = On, h = Jr, m = Kr, g = mm, b = gm, x = bm, w = ym, y = Yi, k = pl, v = Gr, E = hl;
      return H(), $(E, {
        modelValue: r.value,
          ...
          V(v, null, {
            default: N(() => [
              V(m, {
                ...
                default: N(() => [
                  Ze("span", NA, Le(S(n)("editor.image.dialog.title")), 1),
                  V(f),
                  V(h, {
                    class: "mx-0",
                    icon: "",
              ...
              V(b, {
                ...
                default: N(() => [
                  (H(!0), ae(De, null, lt(s.value, (M, O) => (H(), $(g, {
                    key: O,
                    value: O
                  }, {
                    default: N(() => [
              ...
              V(y, null, {
                default: N(() => [
                  V(w, {
                    ...
                    default: N(() => [
                      (H(!0), ae(De, null, lt(s.value, (M, O) => (H(), $(x, {
                        key: O,
                        value: O
                      }, {
                        default: N(() => [
              ...
              V(k, null, {
                default: N(() => [
                  V(h, {
                    ...
                    default: N(() => [
                      Zt(Le(S(n)("editor.image.dialog.button.apply")), 1)
                    ]),
                    _: 1
                  }, 8, ["disabled"])
                ]),
  ...
  setup(t) {
    ...
    const b = bi(function(v) {
      ...
      const { x: E, y: M, w: O, h: B, dir: _ } = S(a), U = (v.clientX - E) * (/l/.test(_) ? -1 : 1), K = (v.clientY - M) * (/t/.test(_) ? -1 : 1), we = vy(O + U, xc, S(r).width), ye = S(c) ? null : Math.max(B + K, xc);
      e.updateAttributes({
        width: we,
        height: ye
      });
    ...
    return ur((v) => {
      ...
      default: N(() => [
        Ze("div", {
          ...
          v.editor.view.editable ? xp((H(), ae("div", HA, [
            (H(!0), ae(De, null, lt(o.value, (M) => (H(), ae("span", {
              key: M,
...
}), PA = /(?:^|\s)(\*(?!\s+\*)((?:[^*]+))\*(?!\s+\*))$/, IA = /(?:^|\s)(\*(?!\s+\*)((?:[^*]+))\*(?!\s+\*))/g, BA = /(?:^|\s)(_(?!\s+_)((?:[^_]+))_(?!\s+_))$/, FA = /(?:^|\s)(_(?!\s+_)((?:[^_]+))_(?!\s+_))/g, zA = /* @__PURE__ */ Ue.create({
  name: "italic",
  addOptions() {
    return {
      HTMLAttributes: {}
...
}), $A = "ö", jA = "ελ1υ2бг1ел3дети4ею2католик6ом3мкд2он1сква6онлайн5рг3рус2ф2сайт3рб3укр3қаз3հայ3ישראל5קום3ابوظبي5رامكو5لاردن4بحرين5جزائر5سعودية6عليان5مغرب5مارات5یران5بارت2زار4يتك3ھارت5تونس4سودان3رية5شبكة4عراق2ب2مان4فلسطين6قطر3كاثوليك6وم3مصر2ليسيا5وريتانيا7قع4همراه5پاکستان7ڀارت4कॉम3नेट3भारत0म्3ोत5संगठन5বাংলা5ভারত2ৰত4ਭਾਰਤ4ભારત4ଭାରତ4இந்தியா6லங்கை6சிங்கப்பூர்11భారత్5ಭಾರತ4ഭാരതം5ලංකා4คอม3ไทย3ລາວ3გე2みんな3アマゾン4クラウド4グーグル4コム2ストア3セール3ファッション6ポイント4世界2中信1国1國1文网3亚马逊3企业2佛山2信息2健康2八卦2公司1益2台湾1灣2商城1店1标2嘉里0大酒店5在线2大拿2天主教3娱乐2家電2广东2微博2慈善2我爱你3手机2招聘2政务1府2新加坡2闻2时尚2書籍2机构2淡马锡3游戏2澳門2点看2移动2组织机构4网址1店1站1络2联通2谷歌2购物2通販2集团2電訊盈科4飞利浦3食品2餐厅2香格里拉3港2닷넷1컴2삼성2한국2", Ur = (t, e) => {
  for (const n in e)
    t[n] = e[n];
  return t;
}, Xu = "numeric", Yu = "ascii", Qu = "alpha", Ti = "asciinumeric", mi = "alphanumeric", el = "domain", P1 = "emoji", WA = "scheme", qA = "slashscheme", iu = "whitespace";
function UA(t, e) {
  return t in e || (e[t] = []), e[t];
}
function Un(t, e, n) {
  e[Xu] && (e[Ti] = !0, e[mi] = !0), e[Yu] && (e[Ti] = !0, e[Qu] = !0), e[Ti] && (e[mi] = !0), e[Qu] && (e[mi] = !0), e[mi] && (e[el] = !0), e[P1] && (e[el] = !0);
  for (const r in e) {
    const i = UA(r, n);
...
const W = (t, e, n, r, i) => t.ta(e, n, r, i), he = (t, e, n, r, i) => t.tr(e, n, r, i), Uf = (t, e, n, r, i) => t.ts(e, n, r, i), T = (t, e, n, r, i) => t.tt(e, n, r, i), Ft = "WORD", tl = "UWORD", I1 = "ASCIINUMERICAL", B1 = "ALPHANUMERICAL", Gi = "LOCALHOST", nl = "TLD", rl = "UTLD", Zo = "SCHEME", Sr = "SLASH_SCHEME", sc = "NUM", il = "WS", ac = "NL", Mi = "OPENBRACE", Ei = "CLOSEBRACE", xs = "OPENBRACKET", ks = "CLOSEBRACKET", Cs = "OPENPAREN", As = "CLOSEPAREN", Ss = "OPENANGLEBRACKET", Ts = "CLOSEANGLEBRACKET", Ms = "FULLWIDTHLEFTPAREN", Es = "FULLWIDTHRIGHTPAREN", Os = "LEFTCORNERBRACKET", Ns = "RIGHTCORNERBRACKET", Ls = "LEFTWHITECORNERBRACKET", Vs = "RIGHTWHITECORNERBRACKET", Hs = "FULLWIDTHLESSTHAN", Rs = "FULLWIDTHGREATERTHAN", Ds = "AMPERSAND", uc = "APOSTROPHE", _s = "ASTERISK", fn = "AT", Ps = "BACKSLASH", Is = "BACKTICK", Bs = "CARET", mn = "COLON", lc = "COMMA", Fs = "DOLLAR", xt = "DOT", zs = "EQUALS", cc = "EXCLAMATION", et = "HYPHEN", Oi = "PERCENT", $s = "PIPE", js = "PLUS", Ws = "POUND", Ni = "QUERY", dc = "QUOTE", F1 = "FULLWIDTHMIDDLEDOT", fc = "SEMI", kt = "SLASH", Li = "TILDE", qs = "UNDERSCORE", z1 = "EMOJI", Us = "SYM";
...
function ZA(t = []) {
  ...
  $e.groups = e;
  const n = new $e();
  Ro == null && (Ro = Gf($A)), Do == null && (Do = Gf(jA)), T(n, "'", uc), T(n, "{", Mi), T(n, "}", Ei), T(n, "[", xs), T(n, "]", ks), T(n, "(", Cs), T(n, ")", As), T(n, "<", Ss), T(n, ">", Ts), T(n, "（", Ms), T(n, "）", Es), T(n, "「", Os), T(n, "」", Ns), T(n, "『", Ls), T(n, "』", Vs), T(n, "＜", Hs), T(n, "＞", Rs), T(n, "&", Ds), T(n, "*", _s), T(n, "@", fn), T(n, "`", Is), T(n, "^", Bs), T(n, ":", mn), T(n, ",", lc), T(n, "$", Fs), T(n, ".", xt), T(n, "=", zs), T(n, "!", cc), T(n, "-", et), T(n, "%", Oi), T(n, "|", $s), T(n, "+", js), T(n, "#", Ws), T(n, "?", Ni), T(n, '"', dc), T(n, "/", kt), T(n, ";", fc), T(n, "~", Li), T(n, "_", qs), T(n, "\\", Ps), T(n, "・", F1);
  const r = he(n, Bt, sc, {
    [Xu]: !0
  });
  he(r, Bt, r);
...
function j1(t, e) {
  const n = XA(e.replace(/[A-Z]/g, (a) => a.toLowerCase())), r = n.length, i = [];
  let o = 0, s = 0;
  for (; s < r; ) {
...
function QA({
  ...
  const e = t.domain.concat([Ds, _s, fn, Ps, Is, Bs, Fs, zs, et, sc, Oi, $s, js, Ws, kt, Us, Li, qs]), n = [mn, lc, xt, cc, Oi, Ni, dc, fc, Ss, Ts, Mi, Ei, ks, xs, Cs, As, Ms, Es, Os, Ns, Ls, Vs, Hs, Rs], r = [Ds, uc, _s, Ps, Is, Bs, Fs, zs, et, Mi, Ei, Oi, $s, js, Ws, Ni, kt, Us, Li, qs], i = Qe(), o = T(i, Li);
  W(o, r, o), W(o, t.domain, o);
  const s = Qe(), a = Qe(), u = Qe();
  ...
  const h = T(d, et);
  T(h, et, h), W(h, t.domain, d), W(p, t.domain, d), T(p, xt, f), T(p, et, h);
  const m = T(p, mn);
  W(m, t.numeric, Zf);
  const g = T(s, et), b = T(s, xt);
  T(g, et, g), W(g, t.domain, s), W(b, r, o), W(b, t.domain, s);
  const x = Qe(_o);
  W(b, t.tld, x), W(b, t.utld, x), W(x, t.domain, s), W(x, r, o), T(x, xt, b), T(x, et, g), T(x, fn, l);
  const w = T(x, mn), y = Qe(_o);
  W(w, t.numeric, y);
  const k = Qe(_o), v = Qe();
  W(k, e, k), W(k, n, v), W(v, e, k), W(v, n, v), T(x, kt, k), T(y, kt, k);
  const E = T(a, mn), M = T(u, mn), O = T(M, kt), B = T(O, kt);
  W(a, t.domain, s), T(a, xt, b), T(a, et, g), W(u, t.domain, s), T(u, xt, b), T(u, et, g), W(E, t.domain, k), T(E, kt, k), T(E, Ni, k), W(B, t.domain, k), W(B, e, k), T(B, kt, k);
  const _ = [
    [Mi, Ei],
    // {}
    [xs, ks],
...
const tS = typeof console < "u" && console && console.warn || (() => {
}), nS = "until manual call of linkify.init(). Register all schemes and plugins before invoking linkify the first time.", ie = {
  scanner: null,
  parser: null,
  tokenQueue: [],
  pluginQueue: [],
...
function Yf(t, e = !1) {
  if (ie.initialized && tS(`linkifyjs: already initialized - will not register custom scheme "${t}" ${nS}`), !/^[0-9a-z]+(-[0-9a-z]+)*$/.test(t))
...
function iS() {
  ie.scanner = ZA(ie.customSchemes);
  for (let t = 0; t < ie.tokenQueue.length; t++)
    ie.tokenQueue[t][1]({
      scanner: ie.scanner
    });
  ie.parser = QA(ie.scanner.tokens);
...
function hc(t) {
  return ie.initialized || iS(), eS(ie.parser.start, t, j1(ie.scanner.start, t));
}
hc.scan = j1;
...
function sS(t) {
  return new se({
    ...
    appendTransaction: (e, n, r) => {
      ...
      if (!i || o)
        return;
      const { tr: s } = r, a = Y4(n.doc, [...e]);
      if (ow(a).forEach(({ newRange: l }) => {
        const c = ew(r.doc, l, (p) => p.isTextblock);
        let d, f;
    ...
    props: {
      handleClick: (e, n, r) => {
        ...
        if (!a.find((f) => f.nodeName === "A"))
          return !1;
        const u = V0(e.state, t.type.name), l = r.target, c = (i = l == null ? void 0 : l.href) !== null && i !== void 0 ? i : u.href, d = (o = l == null ? void 0 : l.target) !== null && o !== void 0 ? o : u.target;
  ...
  return new se({
    ...
    props: {
      handlePaste: (e, n, r) => {
        ...
        const u = q1(a, { defaultProtocol: t.defaultProtocol }).find((l) => l.isLink && l.value === a);
...
function Bn(t, e) {
  ...
  return e && e.forEach((r) => {
    ...
    i && n.push(i);
  }), !t || t.replace(lS, "").match(new RegExp(
    // eslint-disable-next-line no-useless-escape
    `^(?:(?:${n.join("|")}):|[^a-z]|[a-z+.-]+(?:[^a-z+.-:]|$))`,
    "i"
  ));
}
const cS = /* @__PURE__ */ Ue.create({
  name: "link",
  priority: 1e3,
  keepOnSplit: !1,
  exitable: !0,
  ...
  addProseMirrorPlugins() {
    ...
    return this.options.autolink && t.push(sS({
      type: this.type,
      defaultProtocol: this.options.defaultProtocol,
    ...
    })), this.options.openOnClick === !0 && t.push(aS({
      type: this.type
    })), this.options.linkOnPaste && t.push(uS({
      editor: this.editor,
      defaultProtocol: this.options.defaultProtocol,
      type: this.type
    })), t;
...
const dS = { class: "headline" }, fS = /* @__PURE__ */ X({
  __name: "LinkDialog",
  props: {
  ...
  setup(t) {
    const e = t, { t: n } = tn(), r = () => ({
      ...
      target: "_blank",
      rel: ""
    }), i = J(r()), o = J(), { evalHrefRules: s } = U1(["hrefRules"], e), a = J(!1), u = j(() => {
          ...
          V(v, null, {
            default: N(() => [
              V(g, {
                ...
                default: N(() => [
                  Ze("span", dS, Le(S(n)("editor.link.dialog.title")), 1),
                  V(p),
                  V(m, {
                    class: "mx-0",
                    icon: "",
                  ...
                  V(y, null, {
                    default: N(() => [
                      V(m, {
                        ...
                        default: N(() => [
                          Zt(Le(S(n)("editor.link.dialog.button.apply")), 1)
                        ]),
                        _: 1
                      }, 8, ["disabled"])
                    ]),
...
}), hS = "listItem", Qf = "textStyle", ep = /^(\d+)\.\s$/, mS = /* @__PURE__ */ fe.create({
  name: "orderedList",
  addOptions() {
    return {
      itemTypeName: "listItem",
  ...
  addCommands() {
    return {
      toggleOrderedList: () => ({ commands: t, chain: e }) => this.options.keepAttributes ? e().toggleList(this.name, this.options.itemTypeName, this.options.keepMarks).updateAttributes(hS, this.editor.getAttributes(Qf)).run() : t.toggleList(this.name, this.options.itemTypeName, this.options.keepMarks)
    };
  },
  addKeyboardShortcuts() {
    return {
...
}), gS = /(?:^|\s)(~~(?!\s+~~)((?:[^~]+))~~(?!\s+~~))$/, bS = /(?:^|\s)(~~(?!\s+~~)((?:[^~]+))~~(?!\s+~~))/g, yS = /* @__PURE__ */ Ue.create({
  name: "strike",
  addOptions() {
    return {
      HTMLAttributes: {}
  ...
  addExtensions() {
    const t = [];
    return this.options.subscript !== !1 && t.push(vS.configure(this.options.subscript)), this.options.superscript !== !1 && t.push(wS.configure(this.options.superscript)), t;
  }
});
var ol, sl;
if (typeof WeakMap < "u") {
...
var ge = class {
  ...
  static get(t) {
    return ol(t) || sl(t, xS(t));
  }
};
function xS(t) {
  if (t.type.spec.tableRole != "table")
    throw new RangeError("Not a table node: " + t.type.name);
  const e = kS(t), n = t.childCount, r = [];
  let i = 0, o = null;
  const s = [];
...
function CS(t, e, n) {
  ...
  for (let i = 0; i < t.map.length; i++) {
    ...
    for (let l = 0; l < u.colspan; l++) {
      ...
      d != null && (!u.colwidth || u.colwidth[l] != d) && ((a || (a = AS(u)))[l] = d);
    }
...
function HS(t, e, n) {
  ...
  } else r instanceof I && LS(r) ? o = I.create(i, r.from) : r instanceof I && VS(r) && (o = I.create(i, r.$from.start(), r.$from.end()));
  return o && (e || (e = t.tr)).setSelection(o), e;
}
var RS = new be("fix-tables");
function Z1(t, e, n, r) {
  ...
  e:
    for (let s = 0, a = 0; s < o; s++) {
      ...
      r(u, n), a < i && t.child(a).sameMarkup(u) ? Z1(t.child(a), u, n + 1, r) : u.nodesBetween(0, u.content.size, r, n + 1), n += u.nodeSize;
    }
}
function X1(t, e) {
  let n;
  ...
  return e ? e.doc != t.doc && Z1(e.doc, t.doc, 0, r) : t.doc.descendants(r), n;
}
function DS(t, e, n, r) {
  const i = ge.get(e);
  if (!i.problems)
  ...
  return r.setMeta(RS, { fixTables: !0 });
}
function Vt(t) {
...
function Y1(t, { map: e, tableStart: n, table: r }, i) {
  let o = i > 0 ? -1 : 0;
...
function IS(t, { map: e, table: n, tableStart: r }, i) {
...
function BS(t, e) {
  ...
  if (e) {
    ...
    if (n.left == 0 && n.right == n.map.width)
      return !1;
    for (let i = n.right - 1; IS(r, n, i), i != n.left; i--) {
...
function Q1(t, { map: e, tableStart: n, table: r }, i) {
  ...
  const a = [];
  let u = i > 0 ? -1 : 0;
  FS(e, r, i + u) && (u = i == 0 || i == e.height ? null : 0);
...
function rp(t, e) {
  const n = _e(t.schema);
  return US(({ node: r }) => n[r.type.spec.tableRole])(t, e);
}
function US(t) {
  return (e, n) => {
    var r;
...
function GS(t) {
  return function(e, n) {
    if (!gt(e))
      return !1;
    if (n) {
      const r = _e(e.schema), i = Vt(e), o = e.tr, s = i.map.cellsInRect(
        t == "column" ? {
          left: i.left,
          top: 0,
          right: i.right,
...
function Zi(t, e) {
  return e = e || { useDeprecatedLogic: !1 }, e.useDeprecatedLogic ? GS(t) : function(n, r) {
    if (!gt(n))
      return !1;
    if (r) {
      const i = _e(n.schema), o = Vt(n), s = n.tr, a = ip("row", o, i), u = ip(
        "column",
        o,
        i
...
function op(t) {
  return function(e, n) {
    ...
    if (n) {
      ...
      n(
        e.tr.setSelection(I.between(i, MS(i))).scrollIntoView()
      );
    }
    return !0;
  };
...
function eT({ width: t, height: e, rows: n }, r, i) {
  if (t != r) {
    const o = [], s = [];
...
function up(t, e, n, r, i) {
  ...
  tT(d, s, o, n, l, c, f) && p(), sp(d, s, o, n, u, l, a, f) && p(), sp(d, s, o, n, u, l, c, f) && p(), ap(d, s, o, n, a, c, u, f) && p(), ap(d, s, o, n, a, c, l, f) && p();
  for (let h = a; h < c; h++) {
    const m = s.positionAt(h, u, o), g = s.positionAt(h, l, o);
    d.replace(
      d.mapping.slice(f).map(m + n),
      d.mapping.slice(f).map(g + n),
      new L(i.rows[h - a], 0, 0)
    );
  }
  p(), d.setSelection(
    new te(
...
function Io(t, e) {
  return (n, r, i) => {
    ...
    {
      const a = n.doc.resolve(s), u = K1(a, t, e);
      let l;
...
function iT(t, e, n) {
  ...
  if (i instanceof te) {
    ...
    return r = eT(r, a.right - a.left, a.bottom - a.top), up(t.state, t.dispatch, s, a, r), !0;
  } else if (r) {
  ...
  const o = new se({
    ...
    state: {
      init(s, a) {
        ...
        return r && c && (c[d] = (f, p) => new r(f, n, p)), new uT(-1, !1);
      },
      apply(s, a) {
        return a.apply(s);
      }
...
function cT(t) {
  ...
  e && e.activeHandle > -1 && !e.dragging && tm(t, -1);
}
function dT(t, e, n, r) {
  var i;
  ...
  if (!s || s.activeHandle == -1 || s.dragging)
    return !1;
  const a = t.state.doc.nodeAt(s.activeHandle), u = fT(t, s.activeHandle, a.attrs);
  t.dispatch(
...
function fT(t, e, { colspan: n, colwidth: r }) {
...
function hT(t, e, n) {
  ...
  for (let l = 0; l < o.height; l++) {
    ...
    if (f.colwidth && f.colwidth[p] == n)
      continue;
    const h = f.colwidth ? f.colwidth.slice() : mT(f.colspan);
...
const Fo = ({ editor: t }) => {
  ...
  if (!kT(e))
    return !1;
  let n = 0;
  const r = N0(e.ranges[0].$from, (o) => o.type.name === "table");
  return r == null || r.node.descendants((o) => {
    if (o.type.name === "table")
      return !1;
    ["tableCell", "tableHeader"].includes(o.type.name) && (n += 1);
  }), n === e.ranges.length ? (t.commands.deleteTable(), !0) : !1;
}, CT = /* @__PURE__ */ fe.create({
  name: "table",
  // @ts-ignore
  addOptions() {
    return {
  ...
  addCommands() {
    return {
      ...
      addColumnBefore: () => ({ state: t, dispatch: e }) => _S(t, e),
      addColumnAfter: () => ({ state: t, dispatch: e }) => PS(t, e),
      deleteColumn: () => ({ state: t, dispatch: e }) => BS(t, e),
      addRowBefore: () => ({ state: t, dispatch: e }) => zS(t, e),
      addRowAfter: () => ({ state: t, dispatch: e }) => $S(t, e),
      deleteRow: () => ({ state: t, dispatch: e }) => WS(t, e),
      deleteTable: () => ({ state: t, dispatch: e }) => XS(t, e),
      ...
      toggleHeaderCell: () => ({ state: t, dispatch: e }) => JS(t, e),
      mergeOrSplit: () => ({ state: t, dispatch: e }) => np(t, e) ? !0 : rp(t, e),
      setCellAttribute: (t, e) => ({ state: n, dispatch: r }) => KS(t, e)(n, r),
...
}), MT = /(android|bb\d+|meego).+mobile|armv7l|avantgo|bada\/|blackberry|blazer|compal|elaine|fennec|hiptop|iemobile|ip(hone|od)|iris|kindle|lge |maemo|midp|mmp|mobile.+firefox|netfront|opera m(ob|in)i|palm( os)?|phone|p(ixi|re)\/|plucker|pocket|psp|series[46]0|samsungbrowser.*mobile|symbian|treo|up\.(browser|link)|vodafone|wap|windows (ce|phone)|xda|xiino/i, ET = /CrOS/, OT = /android|ipad|playbook|silk/i;
function mp(t = {}) {
  let e = t.ua || typeof navigator < "u" && navigator.userAgent;
  return e && typeof e == "object" && e.headers && typeof e.headers["user-agent"] == "string" && (e = e.headers["user-agent"]), typeof e != "string" ? !1 : !!(MT.test(e) && !ET.test(e) || t.tablet && OT.test(e) || t.tablet && t.featureDetect && navigator && navigator.maxTouchPoints > 1 && e.includes("Macintosh") && e.includes("Safari"));
}
const NT = ["onMouseover", "onMousedown"], LT = /* @__PURE__ */ X({
  ...
  setup(t, { emit: e }) {
    ...
    return (d, f) => {
      const p = Gs, h = Yi, m = vm, g = Gr, b = Ks;
      return H(), $(b, {
        modelValue: i.value,
        ...
        default: N(() => [
          V(g, {
            ...
            default: N(() => [
              ...
              V(h, { class: "d-flex flex-column flex-wrap justify-space-between pa-2" }, {
                default: N(() => [
                  (H(!0), ae(De, null, lt(s.rows, (x) => (H(), ae("div", {
                    key: "r" + x,
                    class: "d-flex"
                  }, [
                    (H(!0), ae(De, null, lt(s.cols, (w) => (H(), ae("div", {
                      key: "c" + w,
                      class: St([{
    ...
    return (a, u) => {
      ...
      return H(), $(h, {
        ...
        default: N(() => [
          V(p, { density: "compact" }, {
            default: N(() => [
              (H(!0), ae(De, null, lt(i.value, (m, g) => (H(), ae(De, null, [
                m.key === "insert-table" ? (H(), $(d, {
                  key: g,
                  disabled: m.disabled
                }, {
                  prepend: N(() => [
                  ...
                  default: N(() => [
                    ...
                    m.key === "insert-table" ? (H(), $(LT, {
                      key: g,
                      onCreateTable: s
                    })) : it("", !0)
                  ]),
                  _: 2
                }, 1032, ["disabled"])) : m.type === "item" ? (H(), $(d, {
                  key: "item-" + g,
                  disabled: m.disabled,
                  onClick: (b) => o(m.key)
                }, {
  ...
  addExtensions() {
    return [
      TT.configure(this.options.tableRow),
      ST.configure(this.options.tableHeader),
      AT.configure(this.options.tableCell)
    ];
  }
}), RT = /^\s*(\[([( |x])?\])\s$/, DT = /* @__PURE__ */ fe.create({
  name: "taskItem",
  addOptions() {
    return {
      nested: !1,
...
}), BT = { class: "headline" }, FT = /* @__PURE__ */ X({
  __name: "VideoDialog",
  props: {
    value: { default: void 0 },
    editor: {},
  ...
  setup(t) {
    const e = t, { t: n } = tn(), r = J(""), i = J(!1), o = J(), { evalHrefRules: s } = U1(["hrefRules"], e), a = j(() => e.value === r.value || !S(r));
    async function u() {
          ...
          V(y, null, {
            default: N(() => [
              V(m, {
                ...
                default: N(() => [
                  Ze("span", BT, Le(S(n)("editor.video.dialog.title")), 1),
                  V(f),
                  V(h, {
                    class: "mx-0",
                    icon: "",
                  ...
                  V(x, null, {
                    default: N(() => [
                      V(h, {
                        ...
                        default: N(() => [
                          Zt(Le(S(n)("editor.video.dialog.button.apply")), 1)
                        ]),
                        _: 1
                      }, 8, ["disabled"])
                    ]),
...
function jT(t, e) {
  return H(), ae("svg", $T, e[0] || (e[0] = [
    Ze("path", {
      d: "M1388.99264 51.648A70.496 70.496 0 0 0 1339.23264 28.96L800.44864 7.84l-40.32 89.984 56.128 167.52-101.12 190.176 41.088 153.408 102.688 131.52 148.512-135.424c14.24-13.312 37.12-12.512 49.792 2.336l190.4 204.288c13.408 14.08 12.608 36.8-1.6 50.112-7.104 6.24-15.808 10.176-25.28 9.376l-522.208-20.352-26.048 74.368 28.416 66.528 600.416 22.72c39.488 1.536 72.672-28.992 73.472-68.128l33.184-843.744c0.8-18.784-5.536-37.568-18.976-50.88zM1003.48864 439.104c-59.264-2.368-105.088-51.68-102.72-109.6a106.368 106.368 0 0 1 110.624-101.76c58.464 2.368 105.056 51.68 102.72 109.6-2.4 57.92-52.16 104.096-110.624 101.76zM616.35264 925.92l18.176-78.272-424.256 28.96a34.752 34.752 0 0 1-37.92-32.096 34.464 34.464 0 0 1 8.704-25.824l314.4-357.696c6.336-7.808 15.808-11.712 26.08-11.712 9.472 0 18.976 3.904 26.08 10.944l105.056 108.8-45.024-115.84L688.25664 252.8l-73.472-160.448L644.83264 0 66.52864 39.904A70.56 70.56 0 0 0 0.16064 115.072l58.464 843.744c0.8 18.784 9.472 36 24.48 47.744a68.576 68.576 0 0 0 51.36 17.216l516.672-35.232-34.752-62.624z",
      fill: "#95A5BD",
      "p-id": "1502"
    }, null, -1)
  ]));
}
const WT = /* @__PURE__ */ nm(zT, [["render", jT]]), qT = { class: "iframe-container" }, UT = ["src", "width", "height", "frameborder", "allowfullscreen"], KT = /* @__PURE__ */ X({
...
}), GT = /* @__PURE__ */ nm(KT, [["__scopeId", "data-v-52377d58"]]), JT = /* @__PURE__ */ X({
...
export {
  ...
  nM as VuetifyTiptap,
  rM as VuetifyViewer,
  HM as createVuetifyProTipTap,
  Dy as de,
  jC as defaultBubbleList,
  _y as en,
  Py as it,
  xu as locale,
  Iy as nl,
