  ...
  return [
    {
      ...
      component: ActionButton,
      componentProps: {
        title: 'editor.table.menu.add_column_before',
    ...
    },
    {
      ...
      component: ActionButton,
      componentProps: {
        title: 'editor.table.menu.add_column_after',
    ...
    },
    {
      ...
      component: ActionButton,
      componentProps: {
        title: 'editor.table.menu.delete_column',
    ...
    },
    {
      ...
      component: ActionButton,
      componentProps: {
        title: 'editor.table.menu.add_row_before',
    ...
    },
    {
      ...
      component: ActionButton,
      componentProps: {
        title: 'editor.table.menu.add_row_after',
    ...
    },
    {
      ...
      component: ActionButton,
      componentProps: {
        title: 'editor.table.menu.delete_row',
        icon: 'tableRowRemove',
    ...
    },
    {
      ...
      component: ActionButton,
      componentProps: {
        title: 'editor.table.menu.merge_or_split_cells',
    ...
    },
    {
      ...
      component: ActionButton,
      componentProps: {
        title: 'editor.table.menu.delete_table',
        icon: 'tableRemove',
