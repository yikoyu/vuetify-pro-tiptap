...
import { ref, unref, computed, watch, onUnmounted } from 'vue-demi'
...
interface VuetifyTiptapEmits {
  (event: 'input', html: string): void
  (event: 'enter'): void
}

const props = withDefaults(defineProps<VuetifyTiptapProps>(), {
  value: '',
  dark: false,
  dense: false,
  outlined: true,
...
const emits = defineEmits<VuetifyTiptapEmits>()
